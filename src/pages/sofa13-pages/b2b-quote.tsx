...
export default function Page() {
  ...
  return (
    <>
      <Helmet>
        <title>Báo giá dự án — Sofa13</title>
      </Helmet>

      <Sofa13PageHero overline="B2B" title={<>BÁO GIÁ <span>DỰ ÁN</span></>} subtitle="Yêu cầu báo giá sofa retro cho dự án lớn." image={SOFA13_PAGE_IMAGES.b2b} />
