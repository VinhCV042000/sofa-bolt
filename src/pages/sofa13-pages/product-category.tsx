    ...
    <>
      ...
      <Sofa13Section>
        <Stack direction="row" spacing={1} alignItems="center" sx={{ mb: 4, flexWrap: 'wrap' }}>
          <RouterLink href="/sofa13/products" sx={{ textDecoration: 'none' }}><Typography variant="body2" sx={{ color: sofa13Alpha(SOFA13_COLORS.ivory, 0.5), fontWeight: 700, '&:hover': { color: SOFA13_COLORS.gold } }}>Sản phẩm</Typography></RouterLink>
