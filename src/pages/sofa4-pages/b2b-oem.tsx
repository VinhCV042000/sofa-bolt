...
const metadata = { title: 'Sản xuất OEM - Sofa Pop' };
...
export default function Page() {
  return (
    <>
      ...
      <Sofa4PageHero overline="Đại lý B2B" title="Yêu cầu sản xuất OEM" subtitle="Sản xuất sofa theo thương hiệu riêng với vật liệu tự nhiên 100%." image={SOFA4_PAGE_IMAGES.b2b} />
            ...
            <Stack spacing={2}>
              {['Tiếp nhận yêu cầu và thiết kế mẫu', 'Báo giá và chốt hợp đồng', 'Sản xuất hàng loạt với vật liệu tự nhiên', 'Kiểm tra chất lượng và đóng gói', 'Giao hàng theo dự án'].map((step, i) => (
                <Stack key={i} direction="row" spacing={2} alignItems="center">
                  <Box sx={{ width: 32, height: 32, borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', bgcolor: 'warning.main', color: 'common.white', fontSize: 14, fontWeight: 'bold' }}>{i + 1}</Box>
