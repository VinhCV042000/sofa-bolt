...
const metadata = { title: 'Tài khoản - Sofa Pop' };
...
export default function Page() {
  return (
    <>
      ...
      <Sofa4PageHero overline="Tài khoản" title="Tài khoản khách hàng" subtitle="Quản lý thông tin và đơn hàng của bạn." image={SOFA4_PAGE_IMAGES.contact} />
        ...
        <Grid container spacing={{ xs: 4, md: 6 }} component={MotionViewport}>
          <Grid xs={12} md={4}>
            <Stack spacing={3} alignItems="center" sx={{ p: 4, borderRadius: 3, bgcolor: 'background.paper', boxShadow: (t) => t.customShadows.card }}>
              <Avatar sx={{ width: 80, height: 80, bgcolor: 'warning.main', fontSize: 32 }}>M</Avatar>
              ...
              <Button variant="outlined" color="warning" size="small" startIcon={<Iconify icon="solar:settings-bold-duotone" />}>Chỉnh sửa hồ sơ</Button>
            </Stack>
          </Grid>
          <Grid xs={12} md={8}>
