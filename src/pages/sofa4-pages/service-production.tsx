...
const metadata = { title: 'Dịch vụ sản xuất - Sofa Pop' };

const SUB_SERVICES = [
  { path: '/sofa4/services/production/oem', title: 'Gia công sofa', icon: 'solar:hammer-bold-duotone', desc: 'Gia công sofa theo yêu cầu với vật liệu tự nhiên.' },
  { path: '/sofa4/services/production/odm', title: 'Sofa ODM', icon: 'solar:armchair-bold-duotone', desc: 'Thiết kế và sản xuất sofa theo thương hiệu riêng.' },
  { path: '/sofa4/services/production/project', title: 'Đặt hàng theo dự án', icon: 'solar:buildings-bold-duotone', desc: 'Sản xuất sofa số lượng lớn cho dự án căn hộ, khách sạn, resort.' },
];
...
export default function Page() {
  ...
  return (
    <>
      ...
      <Sofa4PageHero overline="Dịch vụ" title={activeSub ? activeSub.title : 'Dịch vụ sản xuất'} subtitle={activeSub ? activeSub.desc : 'Gia công sofa OEM, ODM và đặt hàng theo dự án.'} image={SOFA4_PAGE_IMAGES.service2} />
