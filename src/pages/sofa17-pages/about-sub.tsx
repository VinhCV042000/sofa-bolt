...
const SECTIONS: Record<string, { title: string; overline: string; subtitle: string; image: string; content: { heading: string; body: string }[] }> = {
  history: { title: 'LỊCH SỬ HÌNH THÀNH', overline: 'LỊCH SỬ', subtitle: 'Hành trình từ xưởng nhỏ đến Riad Ma-rốc.', image: SOFA17_PAGE_IMAGES.historyHero, content: [{ heading: '2015 — Khởi đầu', body: 'Sofa17 ra đời từ xưởng nhỏ tại Hà Nội với triết lý Riad Ma-rốc.' }, { heading: '2018 — Gold', body: 'Ra mắt Riad Gold Sofa — da thật phủ vàng.' }, { heading: '2020 — Emerald', body: 'Ra mắt Emerald Deco Sofa — vải dệt tay xanh ngọc riad.' }, { heading: '2022 — Showroom', body: 'Mở showroom đầu tiên tại Hà Nội, trải nghiệm Riad.' }, { heading: '2025 — Tương lai', body: '3,200+ tác phẩm đã giao. Tiếp tục Riad Ma-rốc.' }] },
  vision: { title: 'TẦM NHÌN & SỨ MỆNH', overline: 'TẦM NHÌN', subtitle: 'Riad Ma-rốc — vẻ đẹp sang trọng cho mọi không gian.', image: SOFA17_PAGE_IMAGES.aboutHero, content: [{ heading: 'Tầm nhìn', body: 'Trở thành thương hiệu sofa Riad Ma-rốc hàng đầu Việt Nam.' }, { heading: 'Sứ mệnh', body: 'Tạo ra những tuyệt tác Riad — nghệ tây, xanh teal, đỏ ruby.' }, { heading: 'Giá trị', body: 'Thủ công 10+ năm, dệt tay và gỗ tuyết tùng, mỗi tác phẩm là một tuyệt tác.' }] },
  values: { title: 'GIÁ TRỊ CỐT LÕI', overline: 'GIÁ TRỊ', subtitle: '5 giá trị định hình mọi tác phẩm và dịch vụ của Sofa17.', image: SOFA17_PAGE_IMAGES.aboutHero, content: [{ heading: 'Thủ công', body: '10+ năm thủ công, mỗi đường may là một tuyệt tác.' }, { heading: 'Riad Ma-rốc', body: 'Vàng, đen, xanh ngọc riad — Riad Marrakech.' }, { heading: 'Vật liệu', body: 'Da thật và vải dệt tay nhập khẩu cao cấp.' }, { heading: 'Tùy chỉnh', body: 'Đặt màu, da, kích thước riêng. Render 3D 24h.' }, { heading: 'Bền vững', body: 'Bảo hành 10 năm, sửa miễn phí.' }] },
  ...
  team: { title: 'ĐỘI NGŨ NHÂN SỰ', overline: 'ĐỘI NGŨ', subtitle: '45+ chuyên gia tận tâm với Riad Ma-rốc.', image: SOFA17_PAGE_IMAGES.team, content: [{ heading: 'Thiết kế', body: '5 nhà thiết kế Riad Ma-rốc.' }, { heading: 'Thợ may', body: '15+ thợ may da 5+ năm.' }, { heading: 'Thợ bọc', body: '12+ thợ bọc vải dệt tay cao cấp.' }, { heading: 'Stylist', body: '8+ stylist am hiểu Riad Ma-rốc.' }] },
  partners: { title: 'ĐỐI TÁC', overline: 'ĐỐI TÁC', subtitle: 'Đối tác vật liệu, phân phối, và dự án uy tín.', image: SOFA17_PAGE_IMAGES.aboutHero, content: [{ heading: 'Da', body: 'Nhập khẩu da thật Ý, Brazil.' }, { heading: 'Dệt tay', body: 'Dệt tay cao cấp từ Thổ Nhĩ Kỳ.' }, { heading: 'Hotel & Resort', body: 'Đối tác cung cấp sofa cho 40+ hotel, resort 5 sao.' }, { heading: 'Designer', body: 'Hợp tác với 20+ studio thiết kế Riad Ma-rốc.' }] },
