...
export default function Page() {
  ...
  return (
    <>
      <Helmet><title>Nộp CV — Sofa17</title></Helmet>
      <Sofa17PageHero overline="NỘP CV" title={<>NỘP <span>CV</span></>} subtitle={`Ứng tuyển vị trí ${job.title}`} image={SOFA17_PAGE_IMAGES.careers} />
            ...
            {submitted ? (
              ...
              <Sofa17Card accent={SOFA17_COLORS.gold} component={m.div} variants={varFade({ distance: 24 }).inUp}>
                <Stack spacing={3}>
                  ...
                  <Button onClick={() => setSubmitted(true)} size="large" variant="contained" startIcon={<Iconify icon="solar:upload-bold-duotone" />} sx={{ borderRadius: 0, px: 4, py: 1.75, fontWeight: 'fontWeightMedium', color: SOFA17_COLORS.black, bgcolor: SOFA17_COLORS.gold, border: `1px solid ${SOFA17_COLORS.gold}`, '&:hover': { bgcolor: SOFA17_COLORS.goldLight } }}>Gửi hồ sơ</Button>
                </Stack>
              </Sofa17Card>
            )}
          </Grid>
