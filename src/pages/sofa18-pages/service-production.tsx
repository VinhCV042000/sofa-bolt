...
export default function Page() {
  ...
  return (
    <>
      ...
      <Sofa18PageHero overline="DỊCH VỤ" title={<span>{data.title}</span>} subtitle={data.subtitle} image={SOFA18_PAGE_IMAGES.service2} />

      <Sofa18Section bg="cream">
        <Grid container spacing={5} alignItems="center">
          <Grid xs={12} md={6}>
            <Box sx={{ overflow: 'hidden', aspectRatio: '4/3', borderRadius: 3 }}>
              <Box component="img" src={SOFA18_PAGE_IMAGES.service2} alt={data.title} sx={{ width: 1, height: 1, objectFit: 'cover' }} />
            </Box>
          </Grid>
          <Grid xs={12} md={6}>
            <Stack spacing={3}>
              ...
              <Button component={RouterLink} href="/sofa18/b2b/quote" size="large" variant="contained" startIcon={<Iconify icon="solar:document-bold-duotone" />} sx={{ alignSelf: 'flex-start', borderRadius: 2, px: 4, py: 1.75, fontWeight: 'fontWeightMedium', color: 'common.white', bgcolor: SOFA18_COLORS.clay, boxShadow: `0 8px 24px -8px ${varAlpha(SOFA18_COLORS.clay, 0.6)}`, '&:hover': { bgcolor: SOFA18_COLORS.clayDeep } }}>Yêu cầu báo giá</Button>
            </Stack>
          </Grid>
        </Grid>
      </Sofa18Section>
