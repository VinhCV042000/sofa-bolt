...
import { SOFA18_PAGE_PRODUCTS, SOFA18_PAGE_IMAGES, SOFA18_PAGE_PRODUCT_CATEGORIES, formatSofa18Price } from 'src/sections/sofa18-pages/sofa18-pages-data';
        ...
        <Grid container spacing={3}>
          {SOFA18_PAGE_PRODUCTS.map((p) => (
            <Grid key={p.id} xs={12} sm={6} md={4} lg={3}>
              <Stack component={RouterLink} href={`/sofa18/products/${p.slug}`} spacing={1.5} sx={{ textDecoration: 'none', height: 1 }} component={m.div} variants={varFade({ distance: 24 }).inUp}>
