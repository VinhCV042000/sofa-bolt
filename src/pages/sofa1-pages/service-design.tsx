...
import { SOFA1_PROJECTS, SOFA1_PAGE_IMAGES } from 'src/sections/sofa1-pages/sofa1-pages-data';

// ----------------------------------------------------------------------

const metadata = { title: 'Thiết kế nội thất - Casa Sofa' };
...
const SERVICES = [
  ...
  },
  {
    ...
    image: SOFA1_PAGE_IMAGES.service2,
  },
  {
    key: 'consult',
    ...
    image: SOFA1_PAGE_IMAGES.service3,
  },
  {
    key: 'overview',
    icon: 'solar:gallery-bold-duotone',
    title: 'Tổng quan dịch vụ thiết kế',
    description: 'Giải pháp thiết kế nội thất trọn gói từ Casa Sofa — kết hợp tay nghề thủ công và tư duy thẩm mỹ Ý.',
    features: ['Quy trình 4 bước chuyên nghiệp', 'Đội ngũ thiết kế giàu kinh nghiệm', 'Phong cách Ý sang trọng', 'Đồng hành từ ý tưởng đến bàn giao'],
...
export default function Page() {
  ...
  const activeKey = pathname.includes('/custom') ? 'custom' : pathname.includes('/3d') ? '3d' : pathname.includes('/consult') ? 'consult' : 'overview';
  ...
  return (
    <>
      ...
      <Sofa1PageHero
        ...
        subtitle="Từ ý tưởng đến bản vẽ — chúng tôi kiến tạo không gian sống mang dấu ấn thủ công của riêng bạn."
        image={SOFA1_PAGE_IMAGES.service1}
      />
            ...
            return (
              <Grid key={service.key} xs={12} sm={6} md={3}>
                ...
                >
                  ...
                  <Button component={RouterLink} href={`/sofa1/services/design/${service.key === 'overview' ? '' : service.key}`} size="small" sx={{ width: 'fit-content' }} endIcon={<Iconify icon="eva:arrow-ios-forward-fill" />}>
                    Tìm hiểu thêm
                  </Button>
                </Stack>
              </Grid>
      ...
      <Sofa1Section bg="grey">
        ...
        <Grid container spacing={3}>
          {SOFA1_PROJECTS.slice(0, 6).map((project) => (
      ...
      <Sofa1Section>
        <Stack component={MotionViewport} spacing={3} alignItems="center" sx={{ textAlign: 'center', maxWidth: 640, mx: 'auto' }}>
          ...
          <Typography sx={{ color: 'text.secondary' }}>Liên hệ ngay để được tư vấn miễn phí từ đội ngũ thiết kế Casa Sofa.</Typography>
