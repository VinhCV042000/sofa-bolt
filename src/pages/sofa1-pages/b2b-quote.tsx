...
import { SOFA1_PAGE_IMAGES, SOFA1_PROJECT_TYPES } from 'src/sections/sofa1-pages/sofa1-pages-data';

// ----------------------------------------------------------------------

const metadata = { title: 'Báo giá dự án — Casa Sofa' };
...
export default function Page() {
  ...
  return (
    <>
      ...
      <Sofa1PageHero
        title="Báo giá dự án"
        subtitle="Gửi thông tin dự án để nhận báo giá chi tiết từ đội ngũ dự án Casa Sofa."
        image={SOFA1_PAGE_IMAGES.project1}
              ...
              <Grid container spacing={2}>
                ...
                <Grid xs={12} sm={6}>
                  <TextField fullWidth select label="Loại dự án" defaultValue="">
                    {SOFA1_PROJECT_TYPES.map((t) => <MenuItem key={t.slug} value={t.slug}>{t.label}</MenuItem>)}
                  </TextField>
                </Grid>
