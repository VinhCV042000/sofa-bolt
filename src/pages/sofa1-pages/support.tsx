...
import { SOFA1_PAGE_IMAGES, SOFA1_FAQS, SOFA1_COMPANY_INFO } from 'src/sections/sofa1-pages/sofa1-pages-data';

// ----------------------------------------------------------------------

const metadata = { title: 'Hỗ trợ Casa Sofa' };

const OPTIONS = [
  { icon: 'solar:phone-bold-duotone', title: 'Hotline', value: SOFA1_COMPANY_INFO.phone, sub: 'Gọi ngay 8:00 - 20:00' },
  { icon: 'solar:letter-bold-duotone', title: 'Email', value: SOFA1_COMPANY_INFO.email, sub: 'Phản hồi trong 24h' },
...
export default function Page() {
  ...
  return (
    <>
      ...
      <Sofa1PageHero
        title="Hỗ trợ Casa Sofa"
        subtitle="Đội ngũ chăm sóc khách hàng Casa Sofa luôn sẵn sàng giúp bạn giải đáp mọi thắc mắc."
