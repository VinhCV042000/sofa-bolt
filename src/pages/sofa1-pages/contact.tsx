...
const INFO = [
  { icon: 'solar:phone-bold-duotone', label: 'Hotline', value: SOFA1_COMPANY_INFO.phone, sub: 'Hỗ trợ 8:00 - 20:00' },
  { icon: 'solar:letter-bold-duotone', label: 'Email', value: SOFA1_COMPANY_INFO.email, sub: 'Phản hồi trong 24h' },
  { icon: 'solar:map-point-bold-duotone', label: 'Địa chỉ', value: SOFA1_COMPANY_INFO.address, sub: 'Showroom Hà Nội' },
    ...
    <>
          ...
          <Grid xs={12} md={6}>
            <Stack spacing={3} component={m.div} variants={varFade({ distance: 24 }).inRight}>
              ...
              >
                ...
                <Typography variant="caption" sx={{ color: 'text.disabled' }}>{SOFA1_COMPANY_INFO.address}</Typography>
              </Box>
      ...
      <Sofa1Section>
        <Stack spacing={3} alignItems="center" sx={{ textAlign: 'center', maxWidth: 640, mx: 'auto' }} component={MotionViewport}>
          ...
          <Typography sx={{ color: 'text.secondary' }}>Ghé thăm showroom Casa Sofa gần nhất để tận mắt nhìn thấy chất lượng chế tác thủ công.</Typography>
          <Button component={RouterLink} href="/sofa1/showrooms" size="large" variant="contained" color="primary" startIcon={<Iconify icon="solar:map-point-bold-duotone" />}>
            Xem showroom
          </Button>
        </Stack>
      </Sofa1Section>
