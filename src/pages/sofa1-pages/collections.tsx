...
import { SOFA1_PAGE_IMAGES, SOFA1_COLLECTIONS } from 'src/sections/sofa1-pages/sofa1-pages-data';

// ----------------------------------------------------------------------

const metadata = { title: 'Bộ sưu tập - Casa Sofa' };
  ...
  return (
    <>
      ...
      <Sofa1PageHero
        ...
        image={SOFA1_PAGE_IMAGES.cta}
      />

      <Box component="section" sx={{ py: { xs: 8, md: 12 } }}>
        <Container component={MotionViewport}>
          <Grid container spacing={4}>
            {SOFA1_COLLECTIONS.map((col) => (
              <Grid key={col.id} xs={12} sm={6} md={4}>
                <Box component={m.div} variants={varFade({ distance: 24 }).inUp} sx={{ height: 360, borderRadius: 3, overflow: 'hidden' }}>
                  <Stack
                    ...
                    href={`/sofa1/collections/${col.slug}`}
