...
const metadata = { title: 'Showroom - Casa Sofa' };
  ...
  return (
    <>
      ...
      <Sofa1PageHero
        ...
        subtitle="Trải nghiệm trực tiếp chất lượng sofa Casa Sofa tại 4 showroom lớn. Đặt lịch tham quan hoặc tư vấn miễn phí ngay hôm nay."
