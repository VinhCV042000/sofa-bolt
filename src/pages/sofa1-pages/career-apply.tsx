...
const metadata = { title: 'Nộp hồ sơ - Casa Sofa' };
          ...
          {submitted ? (
            ...
            >
              ...
              <Typography sx={{ color: 'text.secondary', maxWidth: 480 }}>
                Cảm ơn bạn đã ứng tuyển vào Casa Sofa. Chúng tôi đã nhận được hồ sơ và sẽ liên hệ với bạn
                trong 3-5 ngày làm việc. Bạn có thể tra cứu tình trạng hồ sơ bất cứ lúc nào.
              </Typography>
              <Stack direction={{ xs: 'column', sm: 'row' }} spacing={2}>
                <Button component={RouterLink} href="/sofa1/careers/tracking" variant="contained" startIcon={<Iconify icon="solar:search-bold-duotone" />}>
                  Tra cứu hồ sơ
                </Button>
                <Button component={RouterLink} href="/sofa1/careers" variant="outlined" startIcon={<Iconify icon="eva:arrow-back-fill" />}>
                  Vị trí khác
                </Button>
              </Stack>
            </Stack>
            ...
            >
              ...
              <Grid container spacing={2}>
                ...
                <Grid xs={12} sm={6}>
                  <TextField fullWidth required label="SĐT *" value={form.phone} onChange={(e) => handleChange('phone', e.target.value)} />
                </Grid>
                <Grid xs={12} sm={6}>
