...
const SECTION_META: Record<string, { title: string; overline: string; image: string; helmet: string }> = {
  history: { title: 'Lịch sử phát triển', overline: 'Hành trình 12 năm', image: SOFA1_PAGE_IMAGES.historyHero, helmet: 'Lịch sử - Casa Sofa' },
  vision: { title: 'Tầm nhìn & Sứ mệnh', overline: 'Định hướng tương lai', image: SOFA1_PAGE_IMAGES.workshop, helmet: 'Tầm nhìn - Casa Sofa' },
  values: { title: 'Giá trị cốt lõi', overline: 'Triết lý thương hiệu', image: SOFA1_PAGE_IMAGES.workshop, helmet: 'Giá trị - Casa Sofa' },
  factory: { title: 'Nhà máy chế tác', overline: 'Năng lực sản xuất', image: SOFA1_PAGE_IMAGES.factory, helmet: 'Nhà máy - Casa Sofa' },
  process: { title: 'Quy trình chế tác', overline: 'Từ ý tưởng đến sản phẩm', image: SOFA1_PAGE_IMAGES.factory, helmet: 'Quy trình - Casa Sofa' },
  technology: { title: 'Công nghệ ứng dụng', overline: 'Đổi mới không ngừng', image: SOFA1_PAGE_IMAGES.technology, helmet: 'Công nghệ - Casa Sofa' },
  certifications: { title: 'Chứng nhận chất lượng', overline: 'Tiêu chuẩn quốc tế', image: SOFA1_PAGE_IMAGES.factory, helmet: 'Chứng nhận - Casa Sofa' },
  team: { title: 'Đội ngũ nghệ nhân', overline: 'Những con người tạo nên Casa Sofa', image: SOFA1_PAGE_IMAGES.team, helmet: 'Đội ngũ - Casa Sofa' },
  partners: { title: 'Đối tác của Casa Sofa', overline: 'Mạng lưới hợp tác', image: SOFA1_PAGE_IMAGES.cta, helmet: 'Đối tác - Casa Sofa' },
  gallery: { title: 'Thư viện ảnh', overline: 'Khoảnh khắc chế tác', image: SOFA1_PAGE_IMAGES.workshop, helmet: 'Thư viện ảnh - Casa Sofa' },
  video: { title: 'Video hoạt động', overline: 'Hình ảnh động', image: SOFA1_PAGE_IMAGES.technology, helmet: 'Video - Casa Sofa' },
};

const VALUES = [
  { icon: 'solar:scale-bold-duotone', title: 'Da Bò Thật 100%', desc: 'Da bò nhập khẩu Ý, vân tự nhiên, thoáng khí và bền đẹp theo năm tháng.' },
  { icon: 'solar:wood-bold-duotone', title: 'Khung Gỗ Sồi', desc: 'Khung gỗ sồi nguyên khối, chịu lực vượt trội và chống cong vênh.' },
  { icon: 'solar:hand-bold-duotone', title: 'Đóng Tay Từng Đường May', desc: 'Nghệ nhân may từng đường kim bằng tay, mỗi sofa mang dấu ấn riêng.' },
];

const VISION = [
  { icon: 'solar:eye-bold-duotone', title: 'Tầm nhìn', desc: 'Trở thành thương hiệu sofa cao cấp số 1 Việt Nam vào năm 2030.' },
  { icon: 'solar:rocket-bold-duotone', title: 'Sứ mệnh', desc: 'Mang đến không gian sống sang trọng và ấm áp cho mọi gia đình Việt.' },
];

const PROCESS_STEPS = [
  { step: '01', title: 'Thiết kế', desc: 'Đội ngũ thiết kế phác thảo 3D theo yêu cầu khách hàng.' },
  { step: '02', title: 'Chọn vật liệu', desc: 'Tuyển chọn gỗ sồi, da bò Ý và vải linen cao cấp.' },
...
const CERTS = [
  ...
  { icon: 'solar:leaf-bold-duotone', title: 'EcoLabel', desc: 'Nhãn sinh thái thân thiện môi trường.' },
  { icon: 'solar:hand-stars-bold-duotone', title: 'QC Vietnam', desc: 'Chứng nhận chất lượng Việt Nam.' },
];
...
const PARTNERS = ['Vingroup', 'Vinpearl', 'Marriott', 'InterContinental', 'Sun Group', 'Novaland'];

const GALLERY = [SOFA1_PAGE_IMAGES.workshop, SOFA1_PAGE_IMAGES.factory, SOFA1_PAGE_IMAGES.technology, SOFA1_PAGE_IMAGES.team, SOFA1_PAGE_IMAGES.product1, SOFA1_PAGE_IMAGES.product7, SOFA1_PAGE_IMAGES.cta, SOFA1_PAGE_IMAGES.contact];

const MILESTONES = [
  { year: '2013', title: 'Thành lập Casa Sofa', description: 'Xưởng mộc nhỏ tại Hà Nội với 5 nghệ nhân, bắt đầu từ sofa bespoke.' },
  { year: '2016', title: 'Mở showroom đầu tiên', description: 'Showroom Casa Sofa Hà Nội ra mắt, đón khách hàng đầu tiên.' },
  { year: '2019', title: 'Nhập khẩu da bò Ý', description: 'Ký hợp đồng nhập khẩu da bò Ý, nâng tầm chất lượng sản phẩm.' },
  { year: '2021', title: 'Mở rộng nhà máy', description: 'Nhà máy mới 5000m² tại Hà Nội, công suất 500 sofa/tháng.' },
  { year: '2023', title: 'Showroom toàn quốc', description: 'Mở showroom tại TP.HCM, Đà Nẵng, Cần Thơ.' },
  { year: '2025', title: 'Đổi mới & bền vững', description: 'Ra mắt bộ sưu tập mới 2025 với vật liệu bền vững.' },
];
...
export default function Page() {
  ...
  const meta = SECTION_META[section] ?? {
    ...
    helmet: 'Không tìm thấy - Casa Sofa',
  };
          ...
          <Grid container spacing={{ xs: 5, md: 8 }} alignItems="center" component={MotionViewport}>
            <Grid xs={12} md={6}>
              <Box component={m.div} variants={varFade({ distance: 24 }).inLeft}>
                <Box component="img" src={SOFA1_PAGE_IMAGES.factory} alt="Nhà máy" sx={{ width: 1, borderRadius: 2, aspectRatio: '4/3', objectFit: 'cover' }} />
              </Box>
            </Grid>
            <Grid xs={12} md={6}>
              <Stack spacing={3} component={m.div} variants={varFade({ distance: 24 }).inRight}>
                <Typography variant="h3">Nhà máy 5000m² tại Hà Nội</Typography>
                <Typography sx={{ color: 'text.secondary' }}>Nhà máy Casa Sofa được trang bị dây chuyền sản xuất hiện đại kết hợp chế tác thủ công, công suất 500 sofa/tháng với hơn 80 nghệ nhân lành nghề.</Typography>
      ...
      case 'video':
        return (
          <Stack spacing={3} component={MotionViewport}>
            {[SOFA1_PAGE_IMAGES.technology, SOFA1_PAGE_IMAGES.factory, SOFA1_PAGE_IMAGES.workshop].map((src, idx) => (
      ...
      default:
        return (
          <Stack spacing={3} alignItems="center" sx={{ textAlign: 'center', py: 10 }}>
            ...
            <Button component={RouterLink} href="/sofa1/about" variant="contained">Quay lại trang Về chúng tôi</Button>
          </Stack>
        );
    }
  }, [section, theme]);
