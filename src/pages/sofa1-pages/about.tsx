  ...
  return (
    <>
            ...
            <Grid xs={12} md={6}>
              <Stack spacing={3} component={m.div} variants={varFade({ distance: 24 }).inRight}>
                ...
                <Typography sx={{ color: 'text.secondary' }}>
                  Casa Sofa ra đời năm {SOFA1_COMPANY_INFO.founded} từ một xưởng mộc nhỏ tại Hà Nội với 5 nghệ nhân. Bắt
                ...
                <Typography sx={{ color: 'text.secondary' }}>
                  ...
                  chọn lọc từng tấm da bò Ý, từng thanh gỗ sồi, may từng đường kim bằng tay để mỗi sản
      ...
      <Box component="section" sx={{ py: { xs: 6, md: 10 } }}>
        <Container component={MotionViewport}>
          <Grid container spacing={3}>
            {SOFA1_COMPANY_INFO.stats.map((s) => (
      ...
      <Box component="section" sx={{ py: { xs: 8, md: 12 }, bgcolor: (t) => varAlpha(t.vars.palette.grey['500Channel'], 0.04) }}>
        <Container component={MotionViewport}>
          <Stack spacing={2} sx={{ textAlign: 'center', maxWidth: 640, mx: 'auto', mb: { xs: 5, md: 8 } }}>
            ...
            <Typography variant="h2">
              Tìm hiểu
              <Box component="span" sx={{ opacity: 0.4 }}> sâu hơn về Casa Sofa</Box>
            </Typography>
          </Stack>
          <Grid container spacing={3}>
            {SUB_PAGES.map((item) => (
      ...
      <Box component="section" sx={{ py: { xs: 8, md: 12 } }}>
        <Container component={MotionViewport}>
          <Stack spacing={4} alignItems="center" sx={{ textAlign: 'center', maxWidth: 640, mx: 'auto', p: { xs: 5, md: 8 }, borderRadius: 3, bgcolor: 'primary.main', color: 'common.white' }}>
            ...
            <Button component={RouterLink} href="/sofa1/showrooms" size="large" variant="contained" color="warning" startIcon={<Iconify icon="solar:calendar-bold-duotone" />}>
              Đặt lịch tư vấn
            </Button>
          </Stack>
        </Container>
