...
import { SOFA16_PAGE_PROJECTS, SOFA16_PAGE_PRODUCTS, sofa16FormatPrice } from 'src/sections/sofa16-pages/sofa16-pages-data';
            ...
            <Stack spacing={4} component={m.div} variants={varFade({ distance: 24 }).inUp}>
              ...
              <Sofa16Card accent={SOFA16_COLORS.terracotta}>
                <Stack spacing={2}>
                  ...
                  <Typography sx={{ color: SOFA16_COLORS.inkSoft, lineHeight: 1.9, fontWeight: 'fontWeightLight' }}>"Sofa16 đã biến không gian của chúng tôi thành một nơi ấm áp. Linen terracotta, olive — tuyệt tác Riviera!"</Typography>
