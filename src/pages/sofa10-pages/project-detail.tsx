...
export default function Page() {
  ...
  return (
    <>
      <Helmet>
        <title>{project.name} — Sofa10</title>
      </Helmet>
      <Sofa10PageHero
        ...
        <Grid container spacing={5}>
          <Grid xs={12} md={8}>
            <Stack spacing={4} component={m.div} variants={varFade({ distance: 24 }).inUp}>
              ...
              <Stack spacing={2}>
                <Typography variant="h4" sx={{ fontWeight: 'fontWeightLight' }}>
                  Mô tả dự án
                </Typography>
                <Typography
                ...
                <Typography
                  sx={{ color: 'text.secondary', lineHeight: 2, fontWeight: 'fontWeightLight' }}
                >
                  Dự án {project.name} là minh chứng cho chất lượng và thẩm mỹ wabi-sabi của Sofa10.
                  Vật liệu mộc, tone trầm, sự tĩnh tại tuyệt đối.
                </Typography>
              </Stack>
              <Stack spacing={2}>
                <Typography variant="h5" sx={{ fontWeight: 'fontWeightNormal' }}>
                  Album ảnh
                </Typography>
                <Grid container spacing={2}>
                  {[
                    SOFA10_PAGE_IMAGES.project1,
                    SOFA10_PAGE_IMAGES.project2,
                    SOFA10_PAGE_IMAGES.project3,
                    SOFA10_PAGE_IMAGES.project4,
                  ].map((img, i) => (
                    <Grid key={i} xs={6} md={3}>
                      <Box sx={{ overflow: 'hidden', borderRadius: 1, aspectRatio: '1/1' }}>
                        <Box
                          component="img"
                          src={img}
                          alt={`Album ${i}`}
              ...
              <Stack spacing={2}>
                ...
                >
                  ...
                  <Typography
                    sx={{ color: 'text.secondary', lineHeight: 2, fontWeight: 'fontWeightLight' }}
                  >
                    &ldquo;Sofa10 đã biến không gian của chúng tôi thành một nơi tĩnh tại tuyệt đối.
                    Vật liệu mộc, tone trầm — khách hàng đều cảm thấy bình an.&rdquo;
                  </Typography>
                  <Typography variant="subtitle2" sx={{ fontWeight: 'fontWeightNormal' }}>
          ...
          <Grid xs={12} md={4}>
            <Stack spacing={3} component={m.div} variants={varFade({ distance: 24 }).inRight}>
              ...
              >
                <Typography variant="h6" sx={{ fontWeight: 'fontWeightNormal' }}>
                  Thông tin dự án
                </Typography>
                <Stack direction="row" justifyContent="space-between">
                  <Typography sx={{ color: 'text.secondary' }}>Loại</Typography>
                  <Typography sx={{ fontWeight: 'fontWeightNormal' }}>
                    {project.typeLabel}
                  </Typography>
                </Stack>
                <Stack direction="row" justifyContent="space-between">
                ...
                <Stack direction="row" justifyContent="space-between">
                  ...
                  <Typography sx={{ fontWeight: 'fontWeightNormal' }}>{project.year}</Typography>
                </Stack>
              </Stack>
              <Stack spacing={2}>
                <Typography variant="h6" sx={{ fontWeight: 'fontWeightNormal' }}>
                ...
                {SOFA10_PAGE_PRODUCTS.slice(0, 3).map((p) => (
                  <Stack
                    ...
                    href={`/sofa10/products/${p.slug}`}
                    direction="row"
                    spacing={2}
                    sx={{
                      textDecoration: 'none',
                      '&:hover .p-name': { color: SOFA10_COLORS.wood },
                    }}
                  >
                    <Box
                      sx={{
                    ...
                    <Stack spacing={0.5} justifyContent="center">
                      ...
                      <Typography
                        variant="caption"
                        sx={{ color: SOFA10_COLORS.wood, fontWeight: 'fontWeightNormal' }}
                      >
                        {formatSofa10Price(p.price)}
                      </Typography>
                    </Stack>
                  </Stack>
                ))}
