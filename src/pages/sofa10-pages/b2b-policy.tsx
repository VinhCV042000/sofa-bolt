...
export default function Page() {
  ...
  return (
    <>
      <Helmet>
        <title>Chính sách đại lý — Sofa10</title>
      </Helmet>

      <Sofa10PageHero overline="B2B" title={<>CHÍNH SÁCH <span>ĐẠI LÝ</span></>} subtitle="Quyền lợi và chính sách dành cho đại lý Sofa10." image={SOFA10_PAGE_IMAGES.b2b} />
