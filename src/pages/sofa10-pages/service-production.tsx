...
const PRODUCTION_SERVICES: Record<
  string,
  { title: string; subtitle: string; content: { heading: string; body: string }[] }
> = {
  default: {
    title: 'DỊCH VỤ SẢN XUẤT',
    subtitle: 'Gia công sofa wabi-sabi chuyên nghiệp — OEM, ODM, dự án.',
    content: [
      { heading: 'Gia công sofa', body: 'Gia công theo bản vẽ, vật liệu wabi-sabi.' },
  ...
  crafting: {
    title: 'GIA CÔNG SOFA',
    subtitle: 'Gia công sofa theo bản vẽ, vật liệu wabi-sabi.',
    content: [
      { heading: 'Bản vẽ', body: 'Nhận bản vẽ, tư vấn vật liệu mộc.' },
  ...
  project: {
    ...
    content: [
      { heading: 'Dự án', body: 'Sản xuất số lượng lớn cho cafe, resort.' },
      { heading: 'Lắp đặt', body: 'Lắp đặt tại dự án, bảo hành 12 năm.' },
    ],
  },
};
  ...
  return (
    <>
      ...
      <Sofa10PageHero
        ...
        image={SOFA10_PAGE_IMAGES.service2}
      />
      <Sofa10Section>
        <Grid container spacing={5} alignItems="center">
          <Grid xs={12} md={6}>
            <Box sx={{ overflow: 'hidden', borderRadius: 2, aspectRatio: '4/3' }}>
              <Box
                component="img"
                src={SOFA10_PAGE_IMAGES.service2}
                alt={data.title}
