...
export default function Page() {
  ...
  return (
    <>
      <Helmet>
        <title>Báo giá dự án — Sofa14</title>
      </Helmet>

      <Sofa14PageHero overline="B2B" title={<>BÁO GIÁ <span>DỰ ÁN</span></>} subtitle="Yêu cầu báo giá sofa retro cho dự án lớn." image={SOFA14_PAGE_IMAGES.b2b} />
