...
export default function Page() {
  ...
  return (
    <>
      ...
      <Sofa14PageHero overline="THANH TOÁN" title={<>PHƯƠNG THỨC <span>THANH TOÁN</span></>} subtitle="Đa dạng phương thức thanh toán an toàn, tiện lợi." image={SOFA14_PAGE_IMAGES.cta} />
