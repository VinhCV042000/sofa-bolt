...
export default function Page() {
  ...
  return (
    <>
      ...
      <Sofa5PageHero overline="LỊCH SỬ" title={<>LỊCH SỬ <span>HÌNH THÀNH</span></>} subtitle="50 năm wabi-sabi — từ xưởng nhỏ Kyoto đến atelier quốc tế." image={SOFA5_PAGE_IMAGES.historyHero} />
