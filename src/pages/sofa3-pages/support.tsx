...
import { SOFA3_FAQS, SOFA3_PAGE_IMAGES } from 'src/sections/sofa3-pages/sofa3-pages-data';

const metadata = { title: 'Hỗ trợ - Sofa Terra' };
...
export default function Page() {
  ...
  return (
    <>
      ...
      <Sofa3PageHero overline="Hỗ trợ" title="Trung tâm hỗ trợ" subtitle="Tìm câu trả lời hoặc liên hệ đội ngũ hỗ trợ." image={SOFA3_PAGE_IMAGES.contact} />
        ...
        <Stack spacing={6} component={MotionViewport}>
          ...
          <Box>
            ...
            <Stack spacing={2} sx={{ maxWidth: 480 }}>
              ...
              <Button variant="contained" color="success" size="large" startIcon={<Iconify icon="solar:letter-bold-duotone" />}>Gửi yêu cầu</Button>
            </Stack>
          </Box>
        </Stack>
      </Sofa3Section>
