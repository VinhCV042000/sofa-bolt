...
export default function Page() {
  return (
    <>
      ...
      <Sofa3PageHero overline="Thanh toán" title="Phương thức thanh toán" subtitle="Chọn phương thức thanh toán phù hợp." image={SOFA3_PAGE_IMAGES.cta} />
        ...
        <Grid container spacing={{ xs: 4, md: 6 }} component={MotionViewport}>
          <Grid xs={12} md={7}>
            <Stack spacing={4}>
              ...
              <Box>
                ...
                <ToggleButtonGroup exclusive color="success" sx={{ flexWrap: 'wrap', gap: 1 }}>
          ...
          <Grid xs={12} md={5}>
            <Stack spacing={3} sx={{ p: 4, borderRadius: 3, bgcolor: 'background.paper', boxShadow: (t) => t.customShadows.card }}>
              ...
              <Stack spacing={1}>
                <Stack direction="row" justifyContent="space-between"><Typography variant="body2" sx={{ color: 'text.secondary' }}>Tạm tính</Typography><Typography variant="subtitle2">{formatSofa3Price(25300000)}</Typography></Stack>
                <Stack direction="row" justifyContent="space-between"><Typography variant="body2" sx={{ color: 'text.secondary' }}>Phí vận chuyển</Typography><Typography variant="subtitle2" sx={{ color: 'success.main' }}>Miễn phí</Typography></Stack>
              ...
              <Stack direction="row" justifyContent="space-between">
                ...
                <Typography variant="h5" sx={{ color: 'success.main', fontWeight: 'fontWeightBold' }}>{formatSofa3Price(25300000)}</Typography>
              </Stack>
              <Button variant="contained" color="success" size="large" fullWidth startIcon={<Iconify icon="solar:wallet-bold-duotone" />}>Thanh toán</Button>
            </Stack>
          </Grid>
        </Grid>
      </Sofa3Section>
