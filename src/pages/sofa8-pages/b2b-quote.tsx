...
export default function Page() {
  ...
  return (
    <>
      <Helmet>
        <title>Báo giá dự án — Sofa8</title>
      </Helmet>

      <Sofa8PageHero overline="B2B" title={<>BÁO GIÁ <span>DỰ ÁN</span></>} subtitle="Yêu cầu báo giá sofa coastal cho dự án lớn." image={SOFA8_PAGE_IMAGES.b2b} />
            ...
            {submitted ? (
              ...
              <Stack spacing={3} component={m.div} variants={varFade({ distance: 24 }).inUp}>
                ...
                <Grid container spacing={2}>
                  ...
                  <Grid xs={12} sm={6}><TextField fullWidth label="Loại dự án" placeholder="Resort, khách sạn..." /></Grid>
