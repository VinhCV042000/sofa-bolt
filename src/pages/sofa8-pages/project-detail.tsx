            ...
            <Stack spacing={4} component={m.div} variants={varFade({ distance: 24 }).inUp}>
              ...
              <Stack spacing={2}>
                ...
                <Stack spacing={2} sx={{ p: 3, borderRadius: 2, bgcolor: 'background.paper', border: `1px solid ${varAlpha(theme.vars.palette.grey['500Channel'], 0.12)}` }}>
                  ...
                  <Typography sx={{ color: 'text.secondary', lineHeight: 1.7 }}>&ldquo;Sofa8 đã biến không gian của chúng tôi thành một resort coastal thực sự. Linen mát, tone biển hoàn hảo. Khách hàng đều khen ngợi!&rdquo;</Typography>
