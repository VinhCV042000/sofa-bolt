...
import { SOFA16_ADMIN_GROUPS } from './sofa16-admin-data';

// ----------------------------------------------------------------------
// Kho dữ liệu CRUD tại chỗ (in-memory) cho khu quản trị sofa16.
// Dữ liệu khởi tạo từ SOFA16_ADMIN_GROUPS và giữ nguyên khi chuyển trang.
// ----------------------------------------------------------------------
...
SOFA16_ADMIN_GROUPS.forEach((group) => {
...
export function useSofa16AdminRows(groupSlug: string, moduleSlug: string) {
