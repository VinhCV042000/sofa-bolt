// SOFA16 ADMIN — các trang tiện ích bổ sung (báo cáo, cài đặt, thông báo, hồ sơ)
// ----------------------------------------------------------------------

export type Sofa16AdminTool = {
  slug: string;
  name: string;
  icon: string;
  description: string;
...
export const SOFA16_ADMIN_TOOLS: Sofa16AdminTool[] = [
  {
    slug: 'reports',
...
export const findSofa16AdminTool = (slug?: string) =>
  SOFA16_ADMIN_TOOLS.find((tool) => tool.slug === slug);

// ----------------------------------------------------------------------

export type Sofa16FunnelStep = {
  label: string;
  value: number;
  icon: string;
  desc: string;
...
export const SOFA16_ADMIN_FUNNEL: Sofa16FunnelStep[] = [
  {
    label: 'Lượt truy cập',
    value: 128400,
...
export const SOFA16_SETTINGS_FIELDS = [
...
export const SOFA16_SETTINGS_TOGGLES = [
...
export const SOFA16_NOTIFICATIONS = [
