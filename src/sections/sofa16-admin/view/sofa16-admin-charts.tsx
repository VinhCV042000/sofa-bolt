...
import {
  ...
  SOFA16_ADMIN_TOP_PRODUCTS,
  SOFA16_ADMIN_ORDER_SERIES,
  SOFA16_ADMIN_CHANNEL_CHART,
  SOFA16_ADMIN_REVENUE_SERIES,
} from '../sofa16-admin-data';

// ----------------------------------------------------------------------

const PALETTE = ['#C66B3D', '#4A7B9D', '#6B7B3A', '#D4B896', '#2E5A7B'];

export function Sofa16AdminCharts() {
  ...
  const channelOptions = useChart({
    colors: PALETTE,
    labels: SOFA16_ADMIN_CHANNEL_CHART.labels,
    stroke: { width: 0 },
  ...
  const topProductOptions = useChart({
    colors: [PALETTE[1]],
    xaxis: { categories: SOFA16_ADMIN_TOP_PRODUCTS.labels },
    ...
    <Grid container spacing={3}>
      <Grid xs={12} md={8}>
        <Card>
          ...
          <Chart
            type="line"
            series={SOFA16_ADMIN_REVENUE_SERIES}
      ...
      <Grid xs={12} md={4}>
        <Card sx={{ height: 1 }}>
          ...
          <Chart
            type="donut"
            series={SOFA16_ADMIN_CHANNEL_CHART.series}
      ...
      <Grid xs={12} md={6}>
        <Card>
          ...
          <Chart
            type="bar"
            series={SOFA16_ADMIN_ORDER_SERIES}
      ...
      <Grid xs={12} md={6}>
        <Card>
          ...
          <Chart
            type="bar"
            series={[{ name: 'Đã bán', data: SOFA16_ADMIN_TOP_PRODUCTS.series }]}
