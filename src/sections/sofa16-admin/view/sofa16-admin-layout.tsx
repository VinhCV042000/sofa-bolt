...
import { SOFA16_ADMIN_ROOT, SOFA16_ADMIN_GROUPS } from '../sofa16-admin-data';
import { SOFA16_ADMIN_TOOLS } from '../sofa16-admin-tools';
...
export function Sofa16AdminLayout({
  children,
  activeGroup,
  activeModule,
  title,
  ...
  const [openGroups, setOpenGroups] = useState<string[]>(
    activeGroup ? [activeGroup] : [SOFA16_ADMIN_GROUPS[0].slug]
  );
...
export const SOFA16_ADMIN_THEME = { BG, SURFACE, ACCENT, TEXT };
