...
import { SOFA7_COLORS, SOFA7_GALLERY } from './sofa7-data';

// ----------------------------------------------------------------------

export function Sofa7Gallery({ sx, ...other }: BoxProps) {
  return (
    <Box
      component="section"
      id="gallery"
              ...
              >
                ...
                <Box
                  sx={{
                    inset: 0,
                    position: 'absolute',
                    background: `linear-gradient(to top, ${varAlpha(SOFA7_COLORS.ink, 0.88)}, transparent 60%)`,
                  }}
                />
                <Stack
                  direction="row"
                ...
                >
                  <Typography variant="subtitle1" sx={{ fontWeight: 'fontWeightBold', textTransform: 'uppercase' }}>
                    {item.title}
                  </Typography>
                  <Stack
                    direction="row"
                  ...
                  >
                    <Iconify icon="solar:bolt-bold-duotone" width={14} sx={{ color: SOFA7_COLORS.ink }} />
                    <Typography variant="caption" sx={{ color: SOFA7_COLORS.ink, fontWeight: 'fontWeightBold', textTransform: 'uppercase' }}>
                      {item.tag}
                    </Typography>
                  </Stack>
                </Stack>
