...
export function Sofa18Steps({ sx, ...other }: BoxProps) {
            ...
            <Grid key={step.title} xs={12} sm={6} md={3}>
              <Box
                ...
                sx={{
                  ...
                  '&:hover': { boxShadow: `0 16px 40px -16px ${varAlpha(SOFA18_COLORS.sage, 0.25)}` },
                }}
              >
                {/* Step number */}
                <Box
                ...
                <Stack spacing={3} sx={{ position: 'relative' }}>
                  ...
                  >
                    <Iconify icon={STEP_ICONS[index]} width={26} sx={{ color: SOFA18_COLORS.sageDeep }} />
                  </Box>
                  <Stack spacing={1}>
                    <Typography variant="h6" sx={{ fontWeight: 'fontWeightMedium', color: SOFA18_COLORS.ink, letterSpacing: 0.3 }}>
                      {step.title}
                    </Typography>
