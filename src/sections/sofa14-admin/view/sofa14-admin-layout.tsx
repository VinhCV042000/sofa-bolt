...
import { SOFA14_ADMIN_ROOT, SOFA14_ADMIN_GROUPS } from '../sofa14-admin-data';
import { SOFA14_ADMIN_TOOLS } from '../sofa14-admin-tools';
...
export function Sofa14AdminLayout({
  children,
  activeGroup,
  activeModule,
  title,
  ...
  const [openGroups, setOpenGroups] = useState<string[]>(
    activeGroup ? [activeGroup] : [SOFA14_ADMIN_GROUPS[0].slug]
  );
...
export const SOFA14_ADMIN_THEME = { BG, SURFACE, ACCENT, TEXT };
