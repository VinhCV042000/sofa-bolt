...
import { SOFA14_ADMIN_GROUPS } from './sofa14-admin-data';

// ----------------------------------------------------------------------
// In-memory CRUD store for the sofa14 admin area.
// ----------------------------------------------------------------------
...
SOFA14_ADMIN_GROUPS.forEach((group) => {
...
export function useSofa14AdminRows(groupSlug: string, moduleSlug: string) {
