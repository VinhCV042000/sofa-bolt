// SOFA19 PAGES — data for all sub-pages scoped under /sofa19/
// Brand: SOFT CLAY / PASTEL POP — claymorphism, candy pastels, chunky blobs, playful & toy-like
// ----------------------------------------------------------------------

import { sofa19Alpha, SOFA19_IMAGES, SOFA19_COLORS } from '../sofa19/sofa19-data';

export { sofa19Alpha };

export function sofa19FormatPrice(value: number) {
...
export const SOFA19_PAGE_PRODUCTS = [
  { id: '1', name: 'Sofa Cloud Mint', slug: 'sofa-cloud-mint', category: 'sofa-vai', style: 'hien-dai', price: 19900000, oldPrice: 23500000, image: SOFA19_PAGE_IMAGES.prod1, images: [SOFA19_PAGE_IMAGES.prod1, SOFA19_PAGE_IMAGES.gallery1], material: 'Cotton pastel · Khung gỗ', size: '220x90cm', colors: [SOFA19_COLORS.jungleLight, SOFA19_COLORS.sand, SOFA19_COLORS.coral], colorNames: ['Mint', 'Sky', 'Coral'], rating: 4.9, reviews: 132, badge: 'bestseller', description: 'Sofa Cloud Mint — cotton pastel, êm như mây. Dành cho không gian tươi sáng.' },
  { id: '2', name: 'Sofa Sky Dream', slug: 'sofa-sky-dream', category: 'sofa-vai', style: 'hien-dai', price: 15900000, image: SOFA19_PAGE_IMAGES.prod2, images: [SOFA19_PAGE_IMAGES.prod2, SOFA19_PAGE_IMAGES.gallery2], material: 'Linen pastel · Khung gỗ', size: '200x85cm', colors: [SOFA19_COLORS.sand, SOFA19_COLORS.jungleLight, SOFA19_COLORS.golden], colorNames: ['Sky', 'Mint', 'Butter'], rating: 4.8, reviews: 98, description: 'Sofa Sky Dream — linen xanh bầu trời, mơ mộng và êm ái.' },
  { id: '3', name: 'Sofa Coral Pop', slug: 'sofa-coral-pop', category: 'sofa-vai', style: 'hien-dai', price: 22500000, image: SOFA19_PAGE_IMAGES.prod3, images: [SOFA19_PAGE_IMAGES.prod3, SOFA19_PAGE_IMAGES.gallery3], material: 'Velvet pastel · Khung gỗ', size: '230x92cm', colors: [SOFA19_COLORS.coral, SOFA19_COLORS.golden, SOFA19_COLORS.jungleLight], colorNames: ['Coral', 'Butter', 'Mint'], rating: 4.9, reviews: 71, badge: 'new', description: 'Sofa Coral Pop — velvet san hô, vui tươi và ấm áp.' },
  { id: '4', name: 'Sofa Butter Soft', slug: 'sofa-butter-soft', category: 'sofa-ni', style: 'hien-dai', price: 27900000, oldPrice: 31900000, image: SOFA19_PAGE_IMAGES.prod4, images: [SOFA19_PAGE_IMAGES.prod4, SOFA19_PAGE_IMAGES.gallery4], material: 'Nỉ pastel · Khung gỗ', size: '240x95cm', colors: [SOFA19_COLORS.golden, SOFA19_COLORS.jungleLight, SOFA19_COLORS.coral], colorNames: ['Butter', 'Mint', 'Coral'], rating: 5.0, reviews: 45, description: 'Sofa Butter Soft — nỉ vàng bơ, mềm mại và ấm áp.' },
  { id: '5', name: 'Sofa Mint Breeze', slug: 'sofa-mint-breeze', category: 'sofa-vai', style: 'bac-au', price: 13500000, image: SOFA19_PAGE_IMAGES.prod5, images: [SOFA19_PAGE_IMAGES.prod5, SOFA19_PAGE_IMAGES.gallery5], material: 'Cotton · Khung gỗ', size: '190x82cm', colors: [SOFA19_COLORS.jungleLight, SOFA19_COLORS.sand], colorNames: ['Mint', 'Sky'], rating: 4.7, reviews: 88, description: 'Sofa Mint Breeze — cotton xanh mint, mát mẻ và tươi mới.' },
  { id: '6', name: 'Sofa Bubble Pop', slug: 'sofa-bubble-pop', category: 'sofa-vai', style: 'hien-dai', price: 9900000, image: SOFA19_PAGE_IMAGES.prod6, images: [SOFA19_PAGE_IMAGES.prod6], material: 'Cotton · Khung gỗ', size: '180x80cm', colors: [SOFA19_COLORS.coral, SOFA19_COLORS.golden, SOFA19_COLORS.sand], colorNames: ['Coral', 'Butter', 'Sky'], rating: 4.8, reviews: 62, badge: 'limited', description: 'Sofa Bubble Pop — cotton pastel, vui tươi như kẹo bông.' },
  { id: '7', name: 'Sofa Cloud L-Shape', slug: 'sofa-cloud-l-shape', category: 'sofa-goc-chu-l', style: 'hien-dai', price: 29900000, image: SOFA19_PAGE_IMAGES.product7, images: [SOFA19_PAGE_IMAGES.product7], material: 'Cotton · Module góc', size: '280x180cm', colors: [SOFA19_COLORS.jungleLight, SOFA19_COLORS.sand, SOFA19_COLORS.coral], colorNames: ['Mint', 'Sky', 'Coral'], rating: 4.9, reviews: 34, badge: 'new', description: 'Sofa góc Cloud — module pastel, êm như mây cho căn hộ.' },
  { id: '8', name: 'Sofa Squish Recliner', slug: 'sofa-squish-recliner', category: 'sofa-recliner', style: 'hien-dai', price: 18900000, image: SOFA19_PAGE_IMAGES.product8, images: [SOFA19_PAGE_IMAGES.product8], material: 'Nỉ · Cơ chế recliner', size: '200x88cm', colors: [SOFA19_COLORS.sand, SOFA19_COLORS.coral], colorNames: ['Sky', 'Coral'], rating: 4.7, reviews: 41, description: 'Sofa recliner Squish — ngả điện, nỉ pastel êm ái.' },
  { id: '9', name: 'Sofa Bounce Bed', slug: 'sofa-bounce-bed', category: 'sofa-giuong', style: 'hien-dai', price: 17500000, image: SOFA19_PAGE_IMAGES.product9, images: [SOFA19_PAGE_IMAGES.product9], material: 'Cotton · Gỗ', size: '200x90cm (giường 200x140cm)', colors: [SOFA19_COLORS.coral, SOFA19_COLORS.golden], colorNames: ['Coral', 'Butter'], rating: 4.8, reviews: 56, description: 'Sofa giường Bounce — 2 chức năng, cotton pastel vui tươi.' },
  { id: '10', name: 'Sofa Pop Accent', slug: 'sofa-pop-accent', category: 'sofa-don', style: 'bac-au', price: 6500000, oldPrice: 8500000, image: SOFA19_PAGE_IMAGES.product10, images: [SOFA19_PAGE_IMAGES.product10], material: 'Cotton · Thép sơn', size: '85x80cm', colors: [SOFA19_COLORS.golden, SOFA19_COLORS.jungleLight, SOFA19_COLORS.coral], colorNames: ['Butter', 'Mint', 'Coral'], rating: 4.9, reviews: 77, badge: 'bestseller', description: 'Ghế sofa đơn Pop — cotton pastel, chân sơn tông. Vui tươi cho góc phòng.' },
];

export const SOFA19_PAGE_COLLECTIONS = [
  { id: 'new', name: 'Bộ sưu tập mới', slug: 'new', description: 'Những mẫu pastel mới nhất 2025', image: SOFA19_PAGE_IMAGES.prod1, count: '10 mẫu', accent: SOFA19_COLORS.jungleLight },
  { id: 'featured', name: 'Bộ sưu tập nổi bật', slug: 'featured', description: 'Các thiết kế được yêu thích nhất', image: SOFA19_PAGE_IMAGES.prod3, count: '8 mẫu', accent: SOFA19_COLORS.coral },
  { id: 'seasonal', name: 'Bộ sưu tập theo mùa', slug: 'seasonal', description: 'Sofa phù hợp từng mùa — tone pastel', image: SOFA19_PAGE_IMAGES.prod4, count: '6 mẫu', accent: SOFA19_COLORS.golden },
  { id: 'luxury', name: 'Bộ sưu tập Luxury', slug: 'luxury', description: 'Velvet pastel cao cấp nhất', image: SOFA19_PAGE_IMAGES.prod5, count: '7 mẫu', accent: SOFA19_COLORS.sand },
  { id: 'bestseller', name: 'Bộ sưu tập Bestseller', slug: 'bestseller', description: 'Những mẫu sofa bán chạy nhất', image: SOFA19_PAGE_IMAGES.prod6, count: '9 mẫu', accent: SOFA19_COLORS.coral },
];

export const SOFA19_PAGE_PROJECTS = [
  { id: '1', name: 'Sunshine Apartment', type: 'can-ho', typeLabel: 'Dự án căn hộ', location: 'TP.HCM', image: SOFA19_PAGE_IMAGES.project1, year: '2024', description: 'Sofa Cloud Mint cho căn hộ Sunshine. Pastel và tươi sáng.' },
  { id: '2', name: 'Pastel Villa', type: 'biet-thu', typeLabel: 'Dự án biệt thự', location: 'Đà Nẵng', image: SOFA19_PAGE_IMAGES.project2, year: '2024', description: 'Sofa Sky Dream cho villa Pastel. Mơ mộng và êm ái.' },
  { id: '3', name: 'Candy Hotel', type: 'khach-san', typeLabel: 'Dự án khách sạn', location: 'Hà Nội', image: SOFA19_PAGE_IMAGES.project3, year: '2023', description: 'Sofa Coral Pop cho hotel Candy. Vui tươi và ấm áp.' },
  { id: '4', name: 'Mint Resort', type: 'resort', typeLabel: 'Dự án resort', location: 'Phú Quốc', image: SOFA19_PAGE_IMAGES.project4, year: '2023', description: 'Sofa Butter Soft cho resort Mint. Mềm mại và thư giãn.' },
  { id: '5', name: 'Bloom Office', type: 'van-phong', typeLabel: 'Dự án văn phòng', location: 'Hà Nội', image: SOFA19_PAGE_IMAGES.project5, year: '2024', description: 'Sofa Mint Breeze cho office Bloom. Tươi mới và sáng tạo.' },
  { id: '6', name: 'Pop Showroom', type: 'showroom', typeLabel: 'Dự án showroom', location: 'TP.HCM', image: SOFA19_PAGE_IMAGES.project6, year: '2025', description: 'Sofa Bubble Pop cho showroom Pop. Vui tươi như kẹo bông.' },
];

export const SOFA19_PAGE_PROJECT_TYPES = [
...
export const SOFA19_PAGE_BLOG_POSTS = [
  { id: '1', title: 'Pastel: Xu hướng nội thất 2025', slug: 'pastel-xu-huong-noi-that-2025', category: 'xu-huong-noi-that', categoryLabel: 'Xu hướng nội thất', excerpt: 'Mint, sky, coral, butter — pastel pop đang lên.', content: 'Pastel pop là xu hướng nội thất 2025...', image: SOFA19_PAGE_IMAGES.blog1, author: 'Mai Lan', date: '15/01/2025', readTime: '5 phút' },
  { id: '2', title: 'Chọn cotton pastel: Hướng dẫn', slug: 'chon-cotton-pastel-huong-dan', category: 'kinh-nghiem-chon-sofa', categoryLabel: 'Kinh nghiệm chọn sofa', excerpt: 'Cotton pastel — cách chọn vải mềm mại.', content: 'Cotton pastel là vải chủ đạo...', image: SOFA19_PAGE_IMAGES.blog2, author: 'Minh Đức', date: '10/01/2025', readTime: '4 phút' },
  { id: '3', title: 'Bảo quản nỉ pastel', slug: 'bao-quan-ni-pastel', category: 'huong-dan-bao-quan', categoryLabel: 'Hướng dẫn bảo quản', excerpt: 'Nỉ pastel — cách chăm sóc mềm mại.', content: 'Nỉ pastel cần chăm sóc đặc biệt...', image: SOFA19_PAGE_IMAGES.blog3, author: 'Thu Trang', date: '05/01/2025', readTime: '4 phút' },
  { id: '4', title: 'Phong thủy phòng khách pastel', slug: 'phong-thuy-phong-khach-pastel', category: 'phong-thuy-noi-that', categoryLabel: 'Phong thủy nội thất', excerpt: 'Pastel và phong thủy — có hợp không?', content: 'Pastel thuộc thổ và kim...', image: SOFA19_PAGE_IMAGES.blog4, author: 'Minh Đức', date: '28/12/2024', readTime: '6 phút' },
  { id: '5', title: 'Velvet pastel: Vật liệu toy-like', slug: 'velvet-pastel-vat-lieu-toy-like', category: 'kien-thuc-vat-lieu', categoryLabel: 'Kiến thức vật liệu', excerpt: 'Velvet pastel — cảm giác claymorphism.', content: 'Velvet pastel mang cảm giác claymorphism...', image: SOFA19_PAGE_IMAGES.blog5, author: 'Mai Lan', date: '20/12/2024', readTime: '5 phút' },
  { id: '6', title: 'Thiết kế phòng khách pastel pop', slug: 'thiet-ke-phong-khach-pastel-pop', category: 'thiet-ke-phong-khach', categoryLabel: 'Thiết kế phòng khách', excerpt: 'Bí quyết tạo không gian claymorphism.', content: 'Claymorphism, candy pastels, chunky blobs...', image: SOFA19_PAGE_IMAGES.blog6, author: 'Thu Trang', date: '15/12/2024', readTime: '5 phút' },
];

export const SOFA19_PAGE_BLOG_CATEGORIES = [
...
export const SOFA19_PAGE_SHOWROOMS = [
  { id: '1', name: 'Sofa19 Bloom Hà Nội', address: '88 Trần Duy Hưng, Cầu Giấy, Hà Nội', phone: '024 3555 7777', hours: '9:00 - 21:00', image: SOFA19_PAGE_IMAGES.showroom1, lat: 21.0137, lng: 105.8258 },
  { id: '2', name: 'Sofa19 Pop TP.HCM', address: '120 Lý Chính Thắng, Quận 11, TP.HCM', phone: '028 3838 8888', hours: '9:00 - 21:00', image: SOFA19_PAGE_IMAGES.showroom2, lat: 10.7726, lng: 106.7069 },
  { id: '3', name: 'Sofa19 Mint Đà Nẵng', address: '40 Bạch Đằng, Hải Châu, Đà Nẵng', phone: '0236 3999 111', hours: '9:00 - 20:00', image: SOFA19_PAGE_IMAGES.showroom3, lat: 16.0544, lng: 108.2022 },
  { id: '4', name: 'Sofa19 Coral Cần Thơ', address: '60 Hòa Bình, Ninh Kiều, Cần Thơ', phone: '0292 3888 222', hours: '9:00 - 20:00', image: SOFA19_PAGE_IMAGES.showroom4, lat: 10.0451, lng: 105.7469 },
];

export const SOFA19_PAGE_CAREERS = [
...
export const SOFA19_PAGE_PRODUCT_CATEGORIES = {
  types: [
...
export const SOFA19_PAGE_PROMOTION_SERVICES = [
...
export const SOFA19_PAGE_FAQS = [
  { question: 'Cotton pastel có dễ bẩn không?', answer: 'Cotton của Sofa19 phủ lớp chống thấm, lau sạch trong 30 giây. Bộ vỏ tháo rời giặt máy.' },
