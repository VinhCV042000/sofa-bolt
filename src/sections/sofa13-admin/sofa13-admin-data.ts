// SOFA13 ADMIN — Art Deco Noir & Gold — admin configuration (demo data)
// ----------------------------------------------------------------------

export const SOFA13_ADMIN_ROOT = '/sofa13/admin';

export type Sofa13AdminColumn = { key: string; label: string; type?: 'text' | 'status' | 'money' | 'number' };

export type Sofa13AdminModule = {
  slug: string;
  name: string;
  description: string;
  icon: string;
  stats: { label: string; value: string; trend?: string }[];
  columns: Sofa13AdminColumn[];
  rows: Record<string, string | number>[];
  actions?: string[];
};

export type Sofa13AdminGroup = {
  slug: string;
  name: string;
  icon: string;
  modules: Sofa13AdminModule[];
};
...
const STATUS_COL: Sofa13AdminColumn = { key: 'status', label: 'Status', type: 'status' };
...
const CMS_GROUP: Sofa13AdminGroup = {
  slug: 'cms',
  name: 'CMS',
  icon: 'solar:documents-bold-duotone',
  modules: [
    cmsPage('home', 'Home', '/sofa13'),
    cmsPage('about', 'About Us', '/sofa13/about'),
    cmsPage('contact', 'Contact', '/sofa13/contact'),
    cmsPage('policy', 'Policy', '/sofa13/policy'),
    cmsPage('terms', 'Terms', '/sofa13/policy/terms'),
    cmsPage('faq', 'FAQ', '/sofa13/faq'),
    mod(
      'blog',
      'Blog',
    ...
    mod(
      ...
      [
        { page: '/sofa13', title: 'SOFA NOIR — Art Deco Sofa Atelier', length: 52, status: 'Good' },
        { page: '/sofa13/about', title: 'About Us | SOFA NOIR', length: 38, status: 'Good' },
        { page: '/sofa13/faq', title: '', length: 0, status: 'Missing meta' },
        { page: '/sofa13/policy', title: 'Purchase Policy | SOFA NOIR', length: 46, status: 'Good' },
      ],
      ['Re-scan']
    ),
    mod(
      ...
      [
        { title: 'Measuring Your Living Room', slug: '/sofa13/guide-measure', status: 'Published', updated: '06/09/2026' },
        { title: 'Material Guarantees', slug: '/sofa13/guarantee', status: 'Published', updated: '01/09/2026' },
        { title: 'Partnership 2026', slug: '/sofa13/partners', status: 'Draft', updated: '12/09/2026' },
      ],
      ['Create page']
    ),
  ],
...
const PRODUCT_GROUP: Sofa13AdminGroup = {
  slug: 'catalog',
  name: 'Products',
...
const WAREHOUSE_GROUP: Sofa13AdminGroup = {
  slug: 'warehouse',
  name: 'Warehouse',
...
const ORDER_GROUP: Sofa13AdminGroup = {
  slug: 'orders',
  name: 'Orders',
...
const CRM_GROUP: Sofa13AdminGroup = {
  slug: 'crm',
  name: 'CRM',
...
const MARKETING_GROUP: Sofa13AdminGroup = {
  slug: 'marketing',
  name: 'Marketing',
...
const ANALYTICS_GROUP: Sofa13AdminGroup = {
  slug: 'analytics',
  name: 'Analytics',
...
const SEO_GROUP: Sofa13AdminGroup = {
  slug: 'seo',
  name: 'SEO',
  icon: 'solar:graph-new-bold-duotone',
  modules: [
    seoPage('category', 'Category Page', '/sofa13/products/category'),
    seoPage('product', 'Product Page', '/sofa13/products'),
    seoPage('collection', 'Collection Page', '/sofa13/collections'),
    seoPage('project', 'Project Page', '/sofa13/projects'),
    seoPage('showroom', 'Showroom Page', '/sofa13/showrooms'),
    seoPage('blog', 'Blog Page', '/sofa13/blog'),
    seoPage('brand', 'Brand Page', '/sofa13/about'),
    mod(
      'sitemap',
      'Sitemap',
    ...
    mod(
      ...
      [
        ...
        { agent: '*', rule: 'Disallow', path: '/sofa13/admin', status: 'Active' },
        { agent: '*', rule: 'Disallow', path: '/sofa13/cart', status: 'Active' },
...
const ACCESS_GROUP: Sofa13AdminGroup = {
  slug: 'access',
  name: 'Access Control',
...
export const SOFA13_ADMIN_GROUPS: Sofa13AdminGroup[] = [
  CMS_GROUP,
  PRODUCT_GROUP,
  WAREHOUSE_GROUP,
  ORDER_GROUP,
...
export function findSofa13AdminModule(groupSlug?: string, moduleSlug?: string) {
  const group = SOFA13_ADMIN_GROUPS.find((g) => g.slug === groupSlug);
  if (!group) return null;
  const found = group.modules.find((m) => m.slug === moduleSlug) ?? group.modules[0];
  return { group, module: found };
}

export const SOFA13_ADMIN_KPIS = [
...
export const SOFA13_ADMIN_ACTIVITIES = [
...
export const SOFA13_ADMIN_CHART_MONTHS = [
  'T1', 'T2', 'T3', 'T4', 'T5', 'T6', 'T7', 'T8', 'T9', 'T10', 'T11', 'T12',
];

export const SOFA13_ADMIN_REVENUE_SERIES = [
