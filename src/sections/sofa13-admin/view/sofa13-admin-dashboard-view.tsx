...
export function Sofa13AdminDashboardView() {
        ...
        <Grid container spacing={3}>
          ...
          <Grid xs={12} md={4}>
            <Card sx={{ p: 3, height: 1 }}>
              ...
              <Stack spacing={2.5}>
                {SOFA13_ADMIN_ACTIVITIES.map((item) => (
