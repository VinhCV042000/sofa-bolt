...
import {
  ...
  SOFA13_ADMIN_TOP_PRODUCTS,
  SOFA13_ADMIN_ORDER_SERIES,
  SOFA13_ADMIN_CHANNEL_CHART,
...
export function Sofa13AdminCharts() {
  ...
  const channelOptions = useChart({
    colors: PALETTE,
    labels: SOFA13_ADMIN_CHANNEL_CHART.labels,
    stroke: { width: 0 },
  ...
  const topProductOptions = useChart({
    colors: [PALETTE[1]],
    xaxis: { categories: SOFA13_ADMIN_TOP_PRODUCTS.labels },
    ...
    <Grid container spacing={3}>
      <Grid xs={12} md={8}>
        <Card>
          ...
          <Chart
            type="line"
            series={SOFA13_ADMIN_REVENUE_SERIES}
      ...
      <Grid xs={12} md={4}>
        <Card sx={{ height: 1 }}>
          ...
          <Chart
            type="donut"
            series={SOFA13_ADMIN_CHANNEL_CHART.series}
      ...
      <Grid xs={12} md={6}>
        <Card>
          ...
          <Chart
            type="bar"
            series={SOFA13_ADMIN_ORDER_SERIES}
      ...
      <Grid xs={12} md={6}>
        <Card>
          ...
          <Chart
            type="bar"
            series={[{ name: 'Sold', data: SOFA13_ADMIN_TOP_PRODUCTS.series }]}
