// SOFA13 ADMIN — utility pages (reports, settings, notifications, profile)
// ----------------------------------------------------------------------

export type Sofa13AdminTool = {
  slug: string;
  name: string;
  icon: string;
  description: string;
...
export const SOFA13_ADMIN_TOOLS: Sofa13AdminTool[] = [
  {
    slug: 'reports',
    name: 'Reports',
...
export const findSofa13AdminTool = (slug?: string) =>
  SOFA13_ADMIN_TOOLS.find((tool) => tool.slug === slug);

// ----------------------------------------------------------------------

export type Sofa13FunnelStep = {
  label: string;
  value: number;
  icon: string;
  desc: string;
...
export const SOFA13_ADMIN_FUNNEL: Sofa13FunnelStep[] = [
  {
    label: 'Visits',
    value: 112600,
...
export const SOFA13_SETTINGS_FIELDS = [
...
export const SOFA13_SETTINGS_TOGGLES = [
...
export const SOFA13_NOTIFICATIONS = [
