...
import { SOFA13_ADMIN_GROUPS } from './sofa13-admin-data';

// ----------------------------------------------------------------------
// In-memory CRUD store for the sofa13 admin area.
// ----------------------------------------------------------------------
...
SOFA13_ADMIN_GROUPS.forEach((group) => {
...
export function useSofa13AdminRows(groupSlug: string, moduleSlug: string) {
