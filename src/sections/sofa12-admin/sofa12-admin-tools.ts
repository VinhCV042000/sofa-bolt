...
export const SOFA12_SETTINGS_FIELDS = [
  { key: 'brand', label: 'Tên thương hiệu', value: 'SOFA TERRA', helper: 'Hiển thị trên toàn site' },
  { key: 'hotline', label: 'Hotline', value: '1900 7878' },
  { key: 'email', label: 'Email hỗ trợ', value: 'hotro@sofaterra.vn' },
  { key: 'address', label: 'Trụ sở', value: '248 Trần Hưng Đạo, Q1, TP.HCM' },
  ...
  { key: 'warranty', label: 'Bảo hành mặc định (tháng)', value: '144' },
];
...
export const SOFA12_SETTINGS_TOGGLES = [
  ...
  { key: 'installment', label: 'Trả góp 0%', desc: 'Liên kết 5 ngân hàng đối tác', on: true },
...
export const SOFA12_NOTIFICATIONS = [
  { time: '09:42', type: 'Đơn hàng', level: 'info', text: '8 đơn mới chờ xác nhận từ kênh Website' },
  { time: '09:05', type: 'Kho hàng', level: 'warning', text: 'SKU AD-MOD-L-NH còn 0 sản phẩm tại Kho TP.HCM' },
  { time: '08:30', type: 'Bảo mật', level: 'error', text: '3 lần đăng nhập sai vào tài khoản havy@sofaterra.vn' },
  { time: '08:02', type: 'Marketing', level: 'success', text: 'Chiến dịch "Sale đất nung" đạt tỷ lệ mở 43%' },
  { time: '07:20', type: 'CMS', level: 'info', text: 'Trang "Bộ sưu tập Dune" được xuất bản' },
  { time: '06:58', type: 'SEO', level: 'warning', text: 'Sitemap phát hiện 4 URL trả lỗi 404' },
  { time: '06:10', type: 'CRM', level: 'success', text: '36 khách hàng mới đăng ký thành viên' },
];

export const SOFA12_PROFILE = {
  name: 'Hà Vy',
  role: 'Quản trị viên cấp cao',
  email: 'havy@sofaterra.vn',
  phone: '0912 345 182',
  team: 'Vận hành số',
  joined: '03/2023',
  ...
  sessions: [
    ...
    { device: 'Windows • Edge', place: 'Hà Nội, VN', time: 'Hôm qua, 16:20' },
  ],
};
