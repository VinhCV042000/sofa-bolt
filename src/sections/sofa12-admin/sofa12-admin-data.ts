// SOFA12 Admin — Terra Arch / Editorial Brutalist theme
// Colors match sofa12: terracotta, ochre, olive on cream

export const SOFA12_ADMIN_ROOT = '/sofa12/admin';

export const SOFA12_ADMIN_THEME = {
  BG: '#2B1B12',
  SURFACE: '#54382A',
  ACCENT: '#B4552D',
  ACCENT2: '#6E7B4F',
...
const cmsModules: Sofa12AdminModule[] = [
  {
    slug: 'home',
    label: 'Trang chủ',
    ...
    rows: [
      { id: 1, section: 'Hero', title: 'TERRA ARCH — Kiến trúc vòm đất nung', status: 'Hoạt động', updated: '2026-09-01' },
      { id: 2, section: 'Marquee', title: 'TERRACOTTA · ARCH · HANDCRAFT', status: 'Hoạt động', updated: '2026-09-01' },
      { id: 3, section: 'Collections', title: 'Bốn bộ sưu tập Terra', status: 'Hoạt động', updated: '2026-08-28' },
      { id: 4, section: 'Products', title: 'Sofa vòm cong thủ công', status: 'Hoạt động', updated: '2026-08-28' },
      { id: 5, section: 'Story', title: 'Câu chuyện thương hiệu', status: 'Hoạt động', updated: '2026-08-20' },
      { id: 6, section: 'Stats', title: '50k+ khách hàng Terra', status: 'Hoạt động', updated: '2026-08-20' },
      { id: 7, section: 'Gallery', title: 'Không gian Terra thực tế', status: 'Hoạt động', updated: '2026-09-02' },
  ...
  },
  {
    ...
    rows: [
      ...
      { id: 2, block: 'Sứ mệnh', content: 'Mang tối giản thủ công vào nội thất', status: 'Hoạt động' },
  ...
  },
  {
    ...
    rows: [
      ...
      { id: 2, field: 'Email', value: 'hello@terraarch.vn', status: 'Hoạt động' },
  ...
  },
  {
    ...
    rows: makeRows(12, () => ({
      title: ['Top 5 mẫu sofa vòm đất nung 2026', 'Nhà nhỏ vẫn có vòm', 'Da thật vs da PU: đâu là lựa chọn tốt?', 'Thiết kế phòng khách tối giản thủ công'][Math.floor(Math.random() * 4)],
  ...
  },
  {
    ...
    rows: [
      { id: 1, label: 'Trang chủ', path: '/sofa12', position: 'Header', status: 'Hoạt động' },
      { id: 2, label: 'Sản phẩm', path: '/sofa12/products', position: 'Header', status: 'Hoạt động' },
      { id: 3, label: 'Bộ sưu tập', path: '/sofa12/collections', position: 'Header', status: 'Hoạt động' },
      { id: 4, label: 'Dự án', path: '/sofa12/projects', position: 'Header', status: 'Hoạt động' },
      { id: 5, label: 'Blog', path: '/sofa12/blog', position: 'Header', status: 'Hoạt động' },
      { id: 6, label: 'Liên hệ', path: '/sofa12/contact', position: 'Header & Footer', status: 'Hoạt động' },
    ],
  ...
  },
  {
    ...
    rows: makeRows(6, () => ({
      name: ['Summer Sale Banner', 'Bộ sưu tập Terra', 'B2B Banner', 'Flash Deal', 'New Arrival'][Math.floor(Math.random() * 5)],
  ...
  },
  {
    ...
    rows: [
      { id: 1, page: 'Trang chủ', title: 'TERRA ARCH — Sofa Vòm Đất Nung', status: 'Hoạt động' },
      { id: 2, page: 'Sản phẩm', title: 'Sofa Terra Arch | TERRA ARCH', status: 'Hoạt động' },
      { id: 3, page: 'Bộ sưu tập', title: 'Bộ sưu tập Terra | TERRA ARCH', status: 'Hoạt động' },
    ],
...
const catalogModules: Sofa12AdminModule[] = [
  {
    slug: 'categories',
    label: 'Danh mục',
    icon: 'solar:widget-bold-duotone',
    description: 'Quản lý danh mục sản phẩm (Terra Arch, Sand Curve, Ochre Lounge…).',
    columns: [
    ...
    rows: [
      { id: 1, name: 'Terra Arch', slug: 'terra-arch', products: 14, status: 'Hoạt động' },
      { id: 2, name: 'Sand Curve', slug: 'sand-curve', products: 11, status: 'Hoạt động' },
      { id: 3, name: 'Ochre Lounge', slug: 'ochre-lounge', products: 8, status: 'Hoạt động' },
      { id: 4, name: 'Olive Grove', slug: 'olive-grove', products: 9, status: 'Hoạt động' },
    ],
  ...
  },
  {
    ...
    rows: [
      { id: 1, name: 'Sofa Terra Vòm', category: 'Terra Arch', price: 22500000, stock: 8, status: 'Hoạt động' },
      { id: 2, name: 'Sofa Cát Cong', category: 'Sand Curve', price: 13900000, stock: 15, status: 'Hoạt động' },
      { id: 3, name: 'Sofa Ochre Ấm', category: 'Ochre Lounge', price: 16500000, stock: 6, status: 'Hoạt động' },
      { id: 4, name: 'Sofa Olive Grove', category: 'Olive Grove', price: 14900000, stock: 11, status: 'Hoạt động' },
      { id: 5, name: 'Sofa Olive Nhung', category: 'Sand Curve', price: 17500000, stock: 4, status: 'Hoạt động' },
      { id: 6, name: 'Sofa Đất Nung Mộc', category: 'Ochre Lounge', price: 18900000, stock: 3, status: 'Hoạt động' },
      ...makeRows(6, () => ({
        name: ['Sofa Terra XL', 'Sofa Băng Đất', 'Sofa Góc Vòm', 'Sofa Ghế Gốm', 'Sofa Cát Rửa', 'Sofa Mộc Hồi Sinh'][Math.floor(Math.random() * 6)],
        category: ['Terra Arch', 'Sand Curve', 'Ochre Lounge', 'Olive Grove'][Math.floor(Math.random() * 4)],
  ...
  },
  {
    ...
    rows: makeRows(12, () => ({
      product: ['Sofa Terra Vòm', 'Sofa Cát Cong', 'Sofa Ochre Ấm'][Math.floor(Math.random() * 3)],
  ...
  },
  {
    ...
    rows: makeRows(10, () => {
      ...
      return {
        ...
        product: ['Sofa Terra Vòm', 'Sofa Cát Cong', 'Sofa Ochre Ấm', 'Sofa Olive Grove'][Math.floor(Math.random() * 4)],
        stock,
        reserved,
...
const warehouseModules: Sofa12AdminModule[] = [
  {
    slug: 'overview',
    label: 'Tổng quan kho',
...
const orderModules: Sofa12AdminModule[] = [
  {
    slug: 'orders',
    label: 'Đơn hàng',
...
const crmModules: Sofa12AdminModule[] = [
  {
    slug: 'customers',
    label: 'Khách hàng',
  ...
  },
  {
    ...
    rows: makeRows(15, () => ({
      ...
      interest: ['Terra Arch', 'Sand Curve', 'Ochre Lounge', 'Tư vấn nội thất'][Math.floor(Math.random() * 4)],
...
const marketingModules: Sofa12AdminModule[] = [
  {
    slug: 'email',
    ...
    rows: makeRows(8, () => ({
      name: ['Sand Curve Flash Sale', 'New Arrival Alert', 'VIP Early Access', 'Ra mắt BST Terra'][Math.floor(Math.random() * 4)],
  ...
  },
  {
    ...
    rows: [
      { id: 1, code: 'TERRA10', discount: '10%', used: 142, limit: 500, status: 'Hoạt động' },
      { id: 2, code: 'ARCH20', discount: '20%', used: 88, limit: 200, status: 'Hoạt động' },
      { id: 3, code: 'SAND30', discount: '30%', used: 200, limit: 200, status: 'Hết lượt' },
      { id: 4, code: 'OCHRE5M', discount: '5.000.000đ', used: 12, limit: 100, status: 'Hoạt động' },
...
const analyticsModules: Sofa12AdminModule[] = [
  {
    slug: 'revenue',
    label: 'Doanh thu',
  ...
  },
  {
    ...
    rows: [
      { id: 1, rank: 1, product: 'Sofa Cát Cong', sold: 312, revenue: 4340000000 },
      { id: 2, rank: 2, product: 'Sofa Terra Vòm', sold: 268, revenue: 6030000000 },
      { id: 3, rank: 3, product: 'Sofa Ochre Ấm', sold: 224, revenue: 3696000000 },
      { id: 4, rank: 4, product: 'Sofa Olive Grove', sold: 198, revenue: 2950000000 },
      { id: 5, rank: 5, product: 'Sofa Olive Nhung', sold: 156, revenue: 2730000000 },
    ],
    stats: [{ label: 'SP bán chạy nhất', value: 'Sofa Cát Cong' }],
  },
  {
    slug: 'traffic',
  ...
  },
  {
    ...
    rows: [
      { id: 1, page: '/sofa12', views: 48200, avg_time: '3m 24s', bounce: '38%' },
      { id: 2, page: '/sofa12/products', views: 32100, avg_time: '4m 12s', bounce: '28%' },
      { id: 3, page: '/sofa12/collections', views: 24800, avg_time: '2m 55s', bounce: '42%' },
      { id: 4, page: '/sofa12/product/brick-leather', views: 18400, avg_time: '5m 08s', bounce: '22%' },
    ],
...
const seoModules: Sofa12AdminModule[] = [
  {
    slug: 'category',
    ...
    rows: [
      { id: 1, page: 'Terra Arch', title: 'Sofa Vòm Đất Nung | TERRA ARCH', score: 88, status: 'Hoạt động' },
      { id: 2, page: 'Sand Curve', title: 'Sofa Cát Cong Ấm | TERRA ARCH', score: 85, status: 'Hoạt động' },
      { id: 3, page: 'Ochre Lounge', title: 'Sofa Ochre Thư Giãn | TERRA ARCH', score: 82, status: 'Hoạt động' },
      { id: 4, page: 'Olive Grove', title: 'Sofa Olive Grove | TERRA ARCH', score: 79, status: 'Hoạt động' },
    ],
  ...
  },
  {
    ...
    rows: makeRows(8, () => ({
      product: ['Sofa Terra Vòm', 'Sofa Cát Cong', 'Sofa Ochre Ấm', 'Sofa Olive Grove'][Math.floor(Math.random() * 4)],
      title: 'Sofa Terra Arch | TERRA ARCH',
  ...
  },
  {
    ...
    rows: [
      { id: 1, collection: 'Terra Arch 2026', title: 'BST Terra Arch 2026 | TERRA ARCH', score: 91, status: 'Hoạt động' },
      { id: 2, collection: 'Sand Curve Edition', title: 'Sand Curve Sofa Collection | TERRA ARCH', score: 87, status: 'Hoạt động' },
    ],
  ...
  },
  {
    ...
    rows: makeRows(5, () => ({
      project: ['Terra Q7', 'Clay Studio', 'Arch Café', 'Creative Office'][Math.floor(Math.random() * 4)],
      title: 'Dự án Nội Thất Terra | TERRA ARCH',
  ...
  },
  {
    ...
    rows: [
      { id: 1, showroom: 'TP.HCM — Q7', title: 'Sofa Showroom Q7 TP.HCM | TERRA ARCH', score: 89, status: 'Hoạt động' },
      { id: 2, showroom: 'Hà Nội — Cầu Giấy', title: 'Sofa Showroom Cầu Giấy HN | TERRA ARCH', score: 85, status: 'Hoạt động' },
    ],
  ...
  },
  {
    ...
    rows: makeRows(6, () => ({
      post: ['Top sofa vòm đất nung', 'Mẹo thiết kế vòm', 'Da thật vs velvet'][Math.floor(Math.random() * 3)],
      keywords: ['sofa vòm', 'sofa đất nung', 'nội thất thủ công'][Math.floor(Math.random() * 3)],
  ...
  },
  {
    ...
    rows: [
      { id: 1, brand: 'TERRA ARCH', title: 'TERRA ARCH — Thương hiệu nội thất vòm đất nung', score: 94, status: 'Hoạt động' },
      { id: 2, brand: 'Clay Craft Co.', title: 'Clay Craft Handmade Furniture', score: 78, status: 'Hoạt động' },
    ],
...
const accessModules: Sofa12AdminModule[] = [
  {
    slug: 'users',
    label: 'Người dùng',
    ...
    rows: [
      { id: 1, name: 'Admin Chính', email: 'admin@terraarch.vn', role: 'Super Admin', last_login: '2026-09-11', status: 'Hoạt động' },
      { id: 2, name: 'Minh Tú', email: 'mintu@terraarch.vn', role: 'Marketing', last_login: '2026-09-10', status: 'Hoạt động' },
      { id: 3, name: 'Hải Đăng', email: 'haidang@terraarch.vn', role: 'Content', last_login: '2026-09-09', status: 'Hoạt động' },
      { id: 4, name: 'Kim Ngân', email: 'kimng@terraarch.vn', role: 'Order Manager', last_login: '2026-09-11', status: 'Hoạt động' },
      { id: 5, name: 'Hoàng Long', email: 'hlong@terraarch.vn', role: 'Warehouse', last_login: '2026-09-08', status: 'Hoạt động' },
    ],
...
export function findSofa12AdminModule(
  groupSlug: string,
  moduleSlug: string
): { group: Sofa12AdminGroup; module: Sofa12AdminModule } | null {
...
export const SOFA12_ADMIN_ACTIVITIES = [
  ...
  { user: 'Minh Tú', action: 'tạo chiến dịch email', target: 'Sand Curve Flash Sale', time: '22 phút trước' },
  { user: 'Hoàng Long', action: 'nhập kho', target: '25 units Sofa Terra Vòm', time: '1 giờ trước' },
  { user: 'Hải Đăng', action: 'xuất bản bài viết', target: 'Top 5 sofa vòm đất nung 2026', time: '2 giờ trước' },
  { user: 'Admin Chính', action: 'thêm mã coupon', target: 'TERRA10', time: '3 giờ trước' },
