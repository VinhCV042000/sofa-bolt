...
const statusColor = (value: string) => {
  ...
  if (/(xuất bản|hoàn tất|thành công|hoạt động|đã duyệt|còn hàng|đang chạy|đã giao|đã hoàn|đủ hàng)/.test(v))
    return 'success';
  if (/(chờ|đang xử lý|nháp|xem xét|mới|sắp hết)/.test(v)) return 'warning';
  if (/(từ chối|hủy|huỷ|lỗi|hết hàng|tạm ẩn|quá hạn|bị khoá|ngừng bán|thất bại)/.test(v)) return 'error';
  return 'default';
};
        ...
        <Grid container spacing={3}>
          ...
          <Grid xs={12}>
            <Card>
              ...
              <TableContainer sx={{ borderTop: `1px solid ${alpha('#B4552D', 0.16)}` }}>
                <Table size="medium">
                  <TableHead>
                    <TableRow>
              ...
              >
                ...
                <Chip
                  ...
                  sx={{ mr: 2, mb: { xs: 2, sm: 0 }, bgcolor: alpha(ACCENT, 0.14), color: '#B4552D' }}
                />
              </Stack>
            </Card>
          </Grid>
