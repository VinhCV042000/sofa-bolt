...
const PALETTE = ['#B4552D', '#6E7B4F', '#7A3318', '#D98E32', '#2B1B12'];
      ...
      <Grid xs={12}>
        <Card sx={{ p: 3 }}>
          <Stack direction="row" justifyContent="space-between" flexWrap="wrap" spacing={2}>
            {[
              { label: 'Giá trị đơn trung bình', value: '14.7tr' },
              { label: 'Tỷ lệ giữ khách', value: '58%' },
              { label: 'Đơn hoàn / đổi trả', value: '1.6%' },
              { label: 'Tồn kho khả dụng', value: '2.840' },
            ].map((item) => (
