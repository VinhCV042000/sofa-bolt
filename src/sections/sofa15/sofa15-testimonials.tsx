...
export function Sofa15Testimonials({ sx, ...other }: BoxProps) {
              ...
              >
                ...
                <Typography
                  sx={{
                    ...
                    right: 20,
                    fontSize: 64,
                    color: varAlpha(SOFA15_COLORS.gold, 0.15),
                ...
                <Rating value={5} readOnly size="small" sx={{ color: SOFA15_COLORS.gold, opacity: 0.7 }} />
                <Typography variant="body2" sx={{ color: varAlpha('#FFFFFF', 0.6), flex: 1, lineHeight: 2, fontWeight: 'fontWeightLight', fontStyle: 'italic' }}>
                  {item.quote}
                </Typography>
                <Stack direction="row" spacing={2} alignItems="center">
                  <Avatar src={AVATARS[index]} alt={item.name} sx={{ border: `1px solid ${varAlpha(SOFA15_COLORS.gold, 0.3)}` }} />
                  <Stack spacing={0.25}>
                    <Typography variant="subtitle2" sx={{ color: 'common.white', fontWeight: 'fontWeightMedium', letterSpacing: 0.3 }}>
                      {item.name}
                    </Typography>
                    <Typography variant="caption" sx={{ color: varAlpha(SOFA15_COLORS.gold, 0.6), fontWeight: 'fontWeightLight' }}>
                      {item.role}
                    </Typography>
                  </Stack>
                </Stack>
