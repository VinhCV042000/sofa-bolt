...
export function Sofa17Testimonials({ sx, ...other }: BoxProps) {
              ...
              >
                <Typography
                  sx={{
                    ...
                    right: 20,
                    fontSize: 64,
                    color: varAlpha(SOFA17_COLORS.saffron, 0.15),
                ...
                <Rating value={5} readOnly size="small" sx={{ color: SOFA17_COLORS.saffron }} />
                <Typography variant="body2" sx={{ color: SOFA17_COLORS.inkSoft, flex: 1, lineHeight: 2, fontWeight: 'fontWeightLight', fontStyle: 'italic' }}>
                  {item.quote}
                </Typography>
                <Stack direction="row" spacing={2} alignItems="center">
                  <Avatar src={AVATARS[index]} alt={item.name} sx={{ border: `2px solid ${varAlpha(SOFA17_COLORS.saffron, 0.3)}` }} />
                  <Stack spacing={0.25}>
                    <Typography variant="subtitle2" sx={{ color: SOFA17_COLORS.ink, fontWeight: 'fontWeightMedium', letterSpacing: 0.3 }}>
                      {item.name}
                    </Typography>
                    <Typography variant="caption" sx={{ color: SOFA17_COLORS.teal, fontWeight: 'fontWeightLight' }}>
                      {item.role}
                    </Typography>
                  </Stack>
                </Stack>
