...
const GALLERY_IMAGES = [
  SOFA17_IMAGES.gallery1,
  SOFA17_IMAGES.gallery2,
  SOFA17_IMAGES.gallery3,
  SOFA17_IMAGES.gallery4,
  SOFA17_IMAGES.gallery5,
  SOFA17_IMAGES.gallery6,
];

export function Sofa17Gallery({ sx, ...other }: BoxProps) {
    ...
    >
      <Container component={MotionViewport}>
        <Stack spacing={3} sx={{ mb: { xs: 6, md: 10 }, maxWidth: 580 }}>
          ...
          <Box component={m.div} variants={varFade({ distance: 24 }).inUp}>
            <Typography variant="h2" sx={{ color: SOFA17_COLORS.cream, fontWeight: 'fontWeightLight', letterSpacing: -0.5 }}>
              ...
              >
                ...
                <Box
                  sx={{
                    inset: 0,
                    position: 'absolute',
                    background: `linear-gradient(to top, ${varAlpha(SOFA17_COLORS.tealDeep, 0.8)}, transparent 60%)`,
                  }}
                />
                <Stack
                  sx={{
                ...
                >
                  <Typography variant="subtitle1" sx={{ fontWeight: 'fontWeightLight', letterSpacing: 0.3, fontStyle: 'italic', color: SOFA17_COLORS.cream }}>
                    {caption}
                  </Typography>
                </Stack>
              </Box>
