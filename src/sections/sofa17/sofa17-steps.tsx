...
export function Sofa17Steps({ sx, ...other }: BoxProps) {
            ...
            <Grid key={step.title} xs={12} sm={6} md={3}>
              <Box
                ...
                sx={{
                  ...
                  '&:hover': { boxShadow: `0 16px 40px -16px ${varAlpha(SOFA17_COLORS.teal, 0.25)}` },
                }}
              >
                {/* Step number */}
                <Box
                ...
                <Stack spacing={3} sx={{ position: 'relative' }}>
                  <Box
                    sx={{
                      ...
                      bgcolor: varAlpha(SOFA17_COLORS.teal, 0.1),
                    }}
                  >
                    <Iconify icon={STEP_ICONS[index]} width={26} sx={{ color: SOFA17_COLORS.teal }} />
                  </Box>
                  <Stack spacing={1}>
                    <Typography variant="h6" sx={{ fontWeight: 'fontWeightMedium', color: SOFA17_COLORS.ink, letterSpacing: 0.3 }}>
                      {step.title}
                    </Typography>
                    <Typography variant="body2" sx={{ color: SOFA17_COLORS.inkSoft, lineHeight: 1.8, fontWeight: 'fontWeightLight' }}>
                      {step.text}
                    </Typography>
                  </Stack>
                </Stack>
