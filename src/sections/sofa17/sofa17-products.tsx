...
export function Sofa17Products({ sx, ...other }: BoxProps) {
  const content = useSofa17Content();

  return (
    <Box component="section" id="products" sx={{ py: { xs: 8, md: 12 }, bgcolor: SOFA17_COLORS.cream, ...sx }} {...other}>
            ...
            <Grid key={product.name} xs={12} sm={6} md={4}>
              <Card
                ...
                sx={{
                  ...
                  border: `1px solid ${varAlpha(SOFA17_COLORS.teal, 0.1)}`,
                  boxShadow: 'none',
                  transition: (theme) => theme.transitions.create('box-shadow', { duration: 400 }),
                  '&:hover': { boxShadow: `0 16px 40px -16px ${varAlpha(SOFA17_COLORS.teal, 0.3)}` },
                }}
              >
                ...
                <Stack spacing={2} sx={{ p: 3.5, flex: 1 }}>
                  <Typography variant="overline" sx={{ color: SOFA17_COLORS.saffronDeep, lineHeight: 1.2, letterSpacing: 2, textTransform: 'uppercase', fontWeight: 'fontWeightMedium' }}>
                    {product.fabric}
                  </Typography>
                  <Typography variant="h6" sx={{ fontWeight: 'fontWeightLight', flex: 1, color: SOFA17_COLORS.ink, letterSpacing: 0.3 }}>
                    {product.name}
                  </Typography>
                  <Stack direction="row" alignItems="center" spacing={0.5}>
                    <Rating value={PRODUCT_RATINGS[index]} readOnly size="small" precision={0.1} sx={{ color: SOFA17_COLORS.saffron }} />
                    <Typography variant="caption" sx={{ color: SOFA17_COLORS.inkSoft }}>
                  ...
                  <Button
                    ...
                    sx={{
                      borderRadius: 2,
                      borderColor: varAlpha(SOFA17_COLORS.teal, 0.3),
                      color: SOFA17_COLORS.teal,
                      fontWeight: 'fontWeightMedium',
                      textTransform: 'none',
                      letterSpacing: 0.5,
                      '&:hover': { borderColor: SOFA17_COLORS.teal, bgcolor: varAlpha(SOFA17_COLORS.teal, 0.06) },
                    }}
                  >
