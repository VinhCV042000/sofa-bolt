...
export function Sofa20Steps({ sx, ...other }: BoxProps) {
            ...
            <Grid key={step.title} xs={12} sm={6} md={3}>
              <Box
                ...
                sx={{
                  ...
                  '&:hover': { boxShadow: `0 16px 40px -16px ${varAlpha(SOFA20_COLORS.copper, 0.25)}` },
                }}
              >
                {/* Step number */}
                <Box
                  sx={{
                    ...
                    color: varAlpha(SOFA20_COLORS.copper, 0.12),
                ...
                <Stack spacing={3} sx={{ position: 'relative' }}>
                  <Box
                    sx={{
                      ...
                      bgcolor: varAlpha(SOFA20_COLORS.espresso, 0.1),
                    }}
                  >
                    <Iconify icon={STEP_ICONS[index]} width={26} sx={{ color: SOFA20_COLORS.espresso }} />
                  </Box>
                  <Stack spacing={1}>
                    <Typography variant="h6" sx={{ fontWeight: 'fontWeightBold', color: SOFA20_COLORS.ink, letterSpacing: 0.3, textTransform: 'uppercase' }}>
                      {step.title}
                    </Typography>
                    <Typography variant="body2" sx={{ color: SOFA20_COLORS.inkSoft, lineHeight: 1.8, fontWeight: 'fontWeightLight' }}>
                      {step.text}
                    </Typography>
                  </Stack>
                </Stack>
