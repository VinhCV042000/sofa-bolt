// SOFA19 ADMIN — các trang tiện ích bổ sung (báo cáo, cài đặt, thông báo, hồ sơ)
// ----------------------------------------------------------------------

export type Sofa19AdminTool = {
  slug: string;
  name: string;
  icon: string;
  description: string;
...
export const SOFA19_ADMIN_TOOLS: Sofa19AdminTool[] = [
  {
    slug: 'reports',
...
export const findSofa19AdminTool = (slug?: string) =>
  SOFA19_ADMIN_TOOLS.find((tool) => tool.slug === slug);

// ----------------------------------------------------------------------

export type Sofa19FunnelStep = {
  label: string;
  value: number;
  icon: string;
  desc: string;
...
export const SOFA19_ADMIN_FUNNEL: Sofa19FunnelStep[] = [
  {
    label: 'Lượt truy cập',
    value: 168000,
...
export const SOFA19_SETTINGS_FIELDS = [
  { key: 'brand', label: 'Tên thương hiệu', value: 'SOFA19 TROPICAL', helper: 'Hiển thị trên toàn site' },
  { key: 'hotline', label: 'Hotline', value: '0800 1919' },
  { key: 'email', label: 'Email hỗ trợ', value: 'atendimento@sofa19.br' },
...
export const SOFA19_SETTINGS_TOGGLES = [
...
export const SOFA19_NOTIFICATIONS = [
  ...
  { time: '08:30', type: 'Bảo mật', level: 'error', text: '6 lần đăng nhập sai vào tài khoản admin@sofa19.br' },
...
export const SOFA19_PROFILE = {
  name: 'Carla Mendes',
  role: 'Quản trị viên cấp cao',
  email: 'carla@sofa19.br',
  phone: '011 9876 5432',
  team: 'Vận hành số',
  joined: '01/2023',
