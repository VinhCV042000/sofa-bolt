// SOFA19 ADMIN — Brazilian Tropical Modern theme (jungle green, coral, golden)
// ----------------------------------------------------------------------

export const SOFA19_ADMIN_ROOT = '/sofa19/admin';

export type Sofa19AdminColumn = { key: string; label: string; type?: 'text' | 'status' | 'money' | 'number' };

export type Sofa19AdminModule = {
  slug: string;
  name: string;
  description: string;
  icon: string;
  stats: { label: string; value: string; trend?: string }[];
  columns: Sofa19AdminColumn[];
  rows: Record<string, string | number>[];
  actions?: string[];
};

export type Sofa19AdminGroup = {
  slug: string;
  name: string;
  icon: string;
  modules: Sofa19AdminModule[];
};
...
const STATUS_COL: Sofa19AdminColumn = { key: 'status', label: 'Trạng thái', type: 'status' };
...
const CMS_GROUP: Sofa19AdminGroup = {
  slug: 'cms',
  name: 'CMS',
  icon: 'solar:documents-bold-duotone',
  modules: [
    cmsPage('home', 'Trang chủ', '/sofa19'),
    cmsPage('about', 'Trang giới thiệu', '/sofa19/about'),
    cmsPage('contact', 'Trang liên hệ', '/sofa19/contact'),
    cmsPage('policy', 'Trang chính sách', '/sofa19/policy'),
    cmsPage('terms', 'Trang điều khoản', '/sofa19/policy/terms'),
    cmsPage('faq', 'Trang FAQ', '/sofa19/faq'),
    mod(
      'blog',
      'Trang blog',
    ...
    mod(
      ...
      [
        { page: '/sofa19', title: 'SOFA19 – Tropical Modern nội thất Brasil', length: 54, status: 'Tốt' },
        { page: '/sofa19/about', title: 'Về chúng tôi | SOFA19', length: 42, status: 'Tốt' },
        { page: '/sofa19/faq', title: '', length: 0, status: 'Thiếu meta' },
        { page: '/sofa19/policy', title: 'Chính sách mua hàng SOFA19', length: 48, status: 'Tốt' },
      ],
      ['Quét lại']
    ),
    mod(
      ...
      [
        { title: 'Hướng dẫn đo kích thước phòng nhiệt đới', slug: '/sofa19/huong-dan-do', status: 'Đã xuất bản', updated: '08/09/2026' },
        { title: 'Cam kết gỗ teak tự nhiên', slug: '/sofa19/cam-ket', status: 'Đã xuất bản', updated: '01/09/2026' },
        { title: 'Tuyển đại lý 2026', slug: '/sofa19/tuyen-dai-ly', status: 'Bản nháp', updated: '14/09/2026' },
      ],
      ['Tạo trang']
    ),
  ],
...
const PRODUCT_GROUP: Sofa19AdminGroup = {
  slug: 'catalog',
  name: 'Sản phẩm',
...
const WAREHOUSE_GROUP: Sofa19AdminGroup = {
  slug: 'warehouse',
  name: 'Kho hàng',
...
const ORDER_GROUP: Sofa19AdminGroup = {
  slug: 'orders',
  name: 'Đơn hàng',
...
const CRM_GROUP: Sofa19AdminGroup = {
  slug: 'crm',
  name: 'CRM',
...
const MARKETING_GROUP: Sofa19AdminGroup = {
  slug: 'marketing',
  name: 'Marketing',
...
const ANALYTICS_GROUP: Sofa19AdminGroup = {
  slug: 'analytics',
  name: 'Analytics',
...
const seoPage = (slug: string, name: string, sample: string) =>
  mod(
    ...
    [
      { url: sample, title: `${name} – SOFA19`, keyword: 'sofa tropical', position: 2, status: 'Tốt' },
...
const SEO_GROUP: Sofa19AdminGroup = {
  slug: 'seo',
  name: 'SEO',
  icon: 'solar:graph-new-bold-duotone',
  modules: [
    seoPage('category', 'Trang danh mục', '/sofa19/products/category'),
    seoPage('product', 'Trang sản phẩm', '/sofa19/products'),
    seoPage('collection', 'Trang bộ sưu tập', '/sofa19/collections'),
    seoPage('project', 'Trang dự án', '/sofa19/projects'),
    seoPage('showroom', 'Trang showroom', '/sofa19/showrooms'),
    seoPage('blog', 'Trang blog', '/sofa19/blog'),
    seoPage('brand', 'Trang thương hiệu', '/sofa19/about'),
    mod(
      'sitemap',
      'Sitemap',
    ...
    mod(
      ...
      [
        ...
        { agent: '*', rule: 'Disallow', path: '/sofa19/admin', status: 'Hoạt động' },
        { agent: '*', rule: 'Disallow', path: '/sofa19/cart', status: 'Hoạt động' },
...
const ACCESS_GROUP: Sofa19AdminGroup = {
  slug: 'access',
  name: 'Phân quyền',
  ...
  modules: [
    mod(
      ...
      [
        { name: 'Carla Mendes', email: 'carla@sofa19.br', role: 'Quản trị hệ thống', last: '15/09/2026 09:18', status: 'Hoạt động' },
        { name: 'Rafael Costa', email: 'rafael@sofa19.br', role: 'Quản lý bán hàng', last: '14/09/2026 17:48', status: 'Hoạt động' },
        { name: 'Juliana Silva', email: 'juliana@sofa19.br', role: 'CSKH', last: '15/09/2026 08:08', status: 'Hoạt động' },
        { name: 'Pedro Alves', email: 'pedro@sofa19.br', role: 'Biên tập nội dung', last: '02/08/2026 10:24', status: 'Bị khoá' },
      ],
      ['Mời người dùng']
    ),
    mod(
...
export const SOFA19_ADMIN_GROUPS: Sofa19AdminGroup[] = [
  CMS_GROUP,
  PRODUCT_GROUP,
  WAREHOUSE_GROUP,
  ORDER_GROUP,
...
export function findSofa19AdminModule(groupSlug?: string, moduleSlug?: string) {
  const group = SOFA19_ADMIN_GROUPS.find((g) => g.slug === groupSlug);
  if (!group) return null;
  const found = group.modules.find((m) => m.slug === moduleSlug) ?? group.modules[0];
  return { group, module: found };
}

export const SOFA19_ADMIN_KPIS = [
...
export const SOFA19_ADMIN_ACTIVITIES = [
...
export const SOFA19_ADMIN_CHART_MONTHS = [
  'T1', 'T2', 'T3', 'T4', 'T5', 'T6', 'T7', 'T8', 'T9', 'T10', 'T11', 'T12',
];

export const SOFA19_ADMIN_REVENUE_SERIES = [
