...
import { SOFA19_ADMIN_ROOT, SOFA19_ADMIN_GROUPS } from '../sofa19-admin-data';
import { SOFA19_ADMIN_TOOLS } from '../sofa19-admin-tools';
...
export function Sofa19AdminLayout({
  children,
  activeGroup,
  activeModule,
  title,
  ...
  const [openGroups, setOpenGroups] = useState<string[]>(
    activeGroup ? [activeGroup] : [SOFA19_ADMIN_GROUPS[0].slug]
  );
...
export const SOFA19_ADMIN_THEME = { BG, SURFACE, ACCENT, ACCENT_DEEP, TEXT };
