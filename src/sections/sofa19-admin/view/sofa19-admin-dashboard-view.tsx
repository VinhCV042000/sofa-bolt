...
export function Sofa19AdminDashboardView() {
  const adminRoot = SOFA19_ADMIN_ROOT;
  const brandName = 'Sofa19';
        ...
        <Grid container spacing={3}>
          ...
          <Grid xs={12} md={4}>
            <Card sx={{ p: 3, height: 1 }}>
              ...
              <Stack spacing={2.5}>
                {SOFA19_ADMIN_ACTIVITIES.map((item) => (
