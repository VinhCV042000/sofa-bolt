...
import { SOFA19_ADMIN_GROUPS } from './sofa19-admin-data';

// ----------------------------------------------------------------------
// Kho dữ liệu CRUD tại chỗ (in-memory) cho khu quản trị sofa19.
// Dữ liệu khởi tạo từ SOFA19_ADMIN_GROUPS và giữ nguyên khi chuyển trang.
// ----------------------------------------------------------------------
...
SOFA19_ADMIN_GROUPS.forEach((group) => {
...
export function useSofa19AdminRows(groupSlug: string, moduleSlug: string) {
