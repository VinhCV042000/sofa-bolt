...
import { SOFA20_ADMIN_ROOT, SOFA20_ADMIN_GROUPS } from '../sofa20-admin-data';
import { SOFA20_ADMIN_TOOLS } from '../sofa20-admin-tools';
...
export function Sofa20AdminLayout({
  children,
  activeGroup,
  activeModule,
  title,
  ...
  const [openGroups, setOpenGroups] = useState<string[]>(
    activeGroup ? [activeGroup] : [SOFA20_ADMIN_GROUPS[0].slug]
  );
...
export const SOFA20_ADMIN_THEME = { BG, SURFACE, ACCENT, ACCENT_DEEP, TEXT };
