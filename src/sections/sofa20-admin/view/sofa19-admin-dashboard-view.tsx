...
export function Sofa20AdminDashboardView() {
  const adminRoot = SOFA20_ADMIN_ROOT;
  const brandName = 'Sofa20';
        ...
        <Grid container spacing={3}>
          ...
          <Grid xs={12} md={4}>
            <Card sx={{ p: 3, height: 1 }}>
              ...
              <Stack spacing={2.5}>
                {SOFA20_ADMIN_ACTIVITIES.map((item) => (
