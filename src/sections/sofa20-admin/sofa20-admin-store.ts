...
import { SOFA20_ADMIN_GROUPS } from './sofa20-admin-data';

// ----------------------------------------------------------------------
// Kho dữ liệu CRUD tại chỗ (in-memory) cho khu quản trị sofa20.
// Dữ liệu khởi tạo từ SOFA20_ADMIN_GROUPS và giữ nguyên khi chuyển trang.
// ----------------------------------------------------------------------
...
SOFA20_ADMIN_GROUPS.forEach((group) => {
...
export function useSofa20AdminRows(groupSlug: string, moduleSlug: string) {
