import { SOFA15_PAGE_IMAGES } from './sofa15-pages-data';

// ----------------------------------------------------------------------

export const SOFA15_AUTH_MODES: Record<string, { title: string; subtitle: string; cta: string }> = {
  login: { title: 'ĐĂNG NHẬP', subtitle: 'Truy cập tài khoản Maison Gatsby của bạn.', cta: 'Đăng nhập' },
...
export const SOFA15_ACCOUNT_SECTIONS = [
...
export const SOFA15_B2B_SECTIONS = [
  { slug: '', title: 'Giới thiệu hợp tác', desc: 'Chương trình hợp tác đại lý & dự án của Maison Gatsby.', icon: 'solar:hand-shake-bold-duotone' },
...
export const SOFA15_SUPPORT_TOPICS = [
  { slug: 'faq', title: 'FAQ', desc: 'Câu hỏi thường gặp', icon: 'solar:question-circle-bold-duotone', path: '/sofa15/faq' },
  { slug: 'help-center', title: 'Trung tâm trợ giúp', desc: 'Hướng dẫn & tài liệu', icon: 'solar:lifebuoy-bold-duotone', path: '/sofa15/support/help-center' },
  { slug: 'chat', title: 'Chat trực tuyến', desc: 'Trò chuyện với tư vấn viên', icon: 'solar:chat-round-bold-duotone', path: '/sofa15/support/chat' },
  { slug: 'ticket', title: 'Gửi ticket hỗ trợ', desc: 'Tạo yêu cầu hỗ trợ', icon: 'solar:ticket-bold-duotone', path: '/sofa15/support/ticket' },
  { slug: 'buying-guide', title: 'Hướng dẫn mua hàng', desc: 'Đặt hàng online từng bước', icon: 'solar:cart-bold-duotone', path: '/sofa15/support/buying-guide' },
  { slug: 'payment-guide', title: 'Hướng dẫn thanh toán', desc: 'Các phương thức thanh toán', icon: 'solar:wallet-bold-duotone', path: '/sofa15/support/payment-guide' },
  { slug: 'shipping', title: 'Chính sách giao hàng', desc: 'Vận chuyển & lắp đặt', icon: 'solar:delivery-bold-duotone', path: '/sofa15/policy/shipping' },
  { slug: 'warranty', title: 'Chính sách bảo hành', desc: 'Bảo hành trọn đời khung', icon: 'solar:shield-check-bold-duotone', path: '/sofa15/policy/warranty' },
  { slug: 'returns', title: 'Chính sách đổi trả', desc: '30 ngày đổi trả', icon: 'solar:refresh-circle-bold-duotone', path: '/sofa15/policy/returns' },
];

export const SOFA15_POLICIES: Record<string, { title: string; intro: string; items: string[] }> = {
  shipping: {
...
export const SOFA15_CART_ITEMS = [
  { id: 'gatsby-01', name: 'Gatsby Velvet Chesterfield', variant: 'Nhung Emerald · 3 chỗ', price: 68000000, qty: 1, image: SOFA15_PAGE_IMAGES.product7 },
  { id: 'gatsby-02', name: 'Deco Fan Lounge', variant: 'Da bò Ý Cognac · 2 chỗ', price: 42000000, qty: 2, image: SOFA15_PAGE_IMAGES.product8 },
];

export const SOFA15_ORDER_STEPS = [
...
export const SOFA15_MEMBER_CUSTOMER = [
...
export const SOFA15_MEMBER_DEALER = [
