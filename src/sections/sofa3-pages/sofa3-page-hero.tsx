...
export function Sofa3PageHero({ title, subtitle, image, overline, sx, ...other }: Sofa3PageHeroProps & Omit<BoxProps, 'title'>) {
          ...
          <Box component={m.div} variants={varFade({ distance: 24 }).inUp}>
            <Typography
              ...
              sx={{
                ...
                '& span': {
                  ...textGradient(`135deg, ${theme.vars.palette.success.light}, ${theme.vars.palette.warning.light}`),
                },
              }}
            >
              {title}
...
export function Sofa3Section({ children, bg = 'default', py = { xs: 8, md: 12 } }: { children: React.ReactNode; bg?: 'default' | 'paper' | 'grey'; py?: { xs: number; md: number } }) {
