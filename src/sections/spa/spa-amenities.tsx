...
import { SPA_IMAGES, SPA_AMENITIES } from './spa-data';
            ...
            <Stack spacing={3}>
              ...
              <Box component={m.div} variants={varFade({ distance: 24 }).inUp}>
                <Typography sx={{ color: 'text.secondary' }}>
                  Serenity Spa mang đến không gian thư giãn đa tiện ích, từ xông hơi, jacuzzi đến
                  khu vực yoga — tất cả trong một điểm đến.
                </Typography>
              </Box>

              <Stack spacing={0}>
                {SPA_AMENITIES.map((item, index) => (
                  <Stack
                    key={item.title}
                    component={m.div}
