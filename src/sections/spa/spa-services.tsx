...
import { SPA_SERVICES } from './spa-data';
        ...
        <Stack spacing={3} sx={{ mb: { xs: 5, md: 8 }, textAlign: 'center', maxWidth: 640, mx: 'auto' }}>
          ...
          <Box component={m.div} variants={varFade({ distance: 24 }).inUp}>
            <Typography sx={{ color: 'text.secondary' }}>
              Khám phá các liệu trình được thiết kế riêng để phục hồi cơ thể, làm đẹp da và cân
              bằng tinh thần.
            </Typography>
          </Box>
        </Stack>
              ...
              >
                ...
                <Stack spacing={2} sx={{ p: 3, flex: 1 }}>
                  ...
                  <Stack direction="row" alignItems="center" spacing={1}>
                    <Iconify icon="solar:clock-circle-bold-duotone" width={18} sx={{ color: 'text.disabled' }} />
