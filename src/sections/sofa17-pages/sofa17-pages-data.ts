...
import { SOFA17_IMAGES, SOFA17_COLORS } from '../sofa17/sofa17-data';

export { varAlpha };

export function sofa17FormatPrice(value: number) {
  return `${value.toLocaleString('vi-VN')}₫`;
}

export const SOFA17_PAGE_IMAGES = {
  ...SOFA17_IMAGES,
...
export const SOFA17_PAGE_PRODUCTS = [
  ...
  { id: '7', name: 'Riad L-Shape Gold', slug: 'riad-l-shape-gold', category: 'sofa-goc-chu-l', style: 'tan-co-dien', price: 68000000, image: SOFA17_PAGE_IMAGES.product7, images: [SOFA17_PAGE_IMAGES.product7], material: 'Da · Module góc', size: '300x200cm', colors: [SOFA17_COLORS.gold, SOFA17_COLORS.black, SOFA17_COLORS.emerald], colorNames: ['Gold', 'Black', 'Emerald'], rating: 5.0, reviews: 8, badge: 'new', description: 'Sofa góc Riad — da phủ vàng, module Riad Ma-rốc.' },
  ...
  { id: '9', name: 'Deco Sofa Bed Gold', slug: 'deco-sofa-bed-gold', category: 'sofa-giuong', style: 'tan-co-dien', price: 28000000, image: SOFA17_PAGE_IMAGES.product9, images: [SOFA17_PAGE_IMAGES.product9], material: 'Da · Gỗ', size: '200x90cm (giường 200x140cm)', colors: [SOFA17_COLORS.black, SOFA17_COLORS.gold], colorNames: ['Black', 'Gold'], rating: 4.7, reviews: 19, description: 'Sofa giường Deco — 2 chức năng, viền vàng Riad Ma-rốc.' },
  { id: '10', name: 'Deco Accent Stool', slug: 'deco-accent-stool', category: 'sofa-don', style: 'tan-co-dien', price: 8500000, oldPrice: 11000000, image: SOFA17_PAGE_IMAGES.product10, images: [SOFA17_PAGE_IMAGES.product10], material: 'Da · Inox mạ vàng', size: '45x45cm', colors: [SOFA17_COLORS.gold, SOFA17_COLORS.black, SOFA17_COLORS.emerald], colorNames: ['Gold', 'Black', 'Emerald'], rating: 4.9, reviews: 26, badge: 'bestseller', description: 'Ghế puff Deco — da vàng, chân inox mạ. Chi tiết Riad Ma-rốc.' },
];

export const SOFA17_PAGE_COLLECTIONS = [
...
export const SOFA17_PAGE_PROJECT_TYPES = [
...
export const SOFA17_PAGE_SHOWROOMS = [
  { id: '1', name: 'Sofa17 Riad Hà Nội', address: '88 Trần Duy Hưng, Cầu Giấy, Hà Nội', phone: '024 3555 8888', hours: '9:00 - 21:00', image: SOFA17_PAGE_IMAGES.showroom1, lat: 21.0137, lng: 105.8258 },
  { id: '2', name: 'Sofa17 Pearl TP.HCM', address: '120 Lý Chính Thắng, Quận 11, TP.HCM', phone: '028 3838 9999', hours: '9:00 - 21:00', image: SOFA17_PAGE_IMAGES.showroom2, lat: 10.7726, lng: 106.7069 },
  { id: '3', name: 'Sofa17 Emerald Đà Nẵng', address: '40 Bạch Đằng, Hải Châu, Đà Nẵng', phone: '0236 3999 222', hours: '9:00 - 20:00', image: SOFA17_PAGE_IMAGES.showroom3, lat: 16.0544, lng: 108.2022 },
  { id: '4', name: 'Sofa17 Gold Cần Thơ', address: '60 Hòa Bình, Ninh Kiều, Cần Thơ', phone: '0292 3888 333', hours: '9:00 - 20:00', image: SOFA17_PAGE_IMAGES.showroom4, lat: 10.0451, lng: 105.7469 },
];
...
export const SOFA17_PAGE_PRODUCT_CATEGORIES = {
  types: [
...
export const SOFA17_PAGE_PROMOTION_SERVICES = [
