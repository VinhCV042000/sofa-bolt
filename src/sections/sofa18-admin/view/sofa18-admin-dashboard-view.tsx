...
export function Sofa18AdminDashboardView() {
  const adminRoot = SOFA18_ADMIN_ROOT;
  const brandName = 'Sofa18';
        ...
        <Grid container spacing={3}>
          ...
          <Grid xs={12} md={4}>
            <Card sx={{ p: 3, height: 1 }}>
              ...
              <Stack spacing={2.5}>
                {SOFA18_ADMIN_ACTIVITIES.map((item) => (
