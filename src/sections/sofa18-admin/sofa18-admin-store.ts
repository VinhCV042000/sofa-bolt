...
import { SOFA18_ADMIN_GROUPS } from './sofa18-admin-data';

// ----------------------------------------------------------------------
// Kho dữ liệu CRUD tại chỗ (in-memory) cho khu quản trị sofa18.
// Dữ liệu khởi tạo từ SOFA18_ADMIN_GROUPS và giữ nguyên khi chuyển trang.
// ----------------------------------------------------------------------
...
SOFA18_ADMIN_GROUPS.forEach((group) => {
...
export function useSofa18AdminRows(groupSlug: string, moduleSlug: string) {
