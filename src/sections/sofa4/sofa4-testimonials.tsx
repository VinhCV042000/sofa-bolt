...
import { SOFA4_TESTIMONIALS } from './sofa4-data';

// ----------------------------------------------------------------------

export function Sofa4Testimonials({ sx, ...other }: BoxProps) {
  return (
    <Box component="section" id="testimonials" sx={{ py: { xs: 8, md: 12 }, ...sx }} {...other}>
      <Container component={MotionViewport}>
        ...
        <Grid container spacing={3}>
          {SOFA4_TESTIMONIALS.map((testimonial, index) => (
            <Grid key={testimonial.name} xs={12} sm={6} md={3}>
              ...
              >
                <Iconify
                  ...
                  width={32}
                  sx={{ color: 'warning.main', transform: 'rotate(180deg)', mb: 2 }}
                />
