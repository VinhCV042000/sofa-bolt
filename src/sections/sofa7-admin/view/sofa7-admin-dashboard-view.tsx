...
export function Sofa7AdminDashboardView() {
        ...
        <Grid container spacing={3}>
                  ...
                  <Grid key={group.slug} xs={12} sm={6}>
                    <ButtonBase
                      ...
                      sx={{
                        ...
                        border: `1px solid ${alpha('#8A7300', 0.2)}`,
                        transition: 'all .2s',
          ...
          <Grid xs={12} md={4}>
            <Card sx={{ p: 3, height: 1 }}>
              ...
              <Stack spacing={2.5}>
                {SOFA7_ADMIN_ACTIVITIES.map((item) => (
