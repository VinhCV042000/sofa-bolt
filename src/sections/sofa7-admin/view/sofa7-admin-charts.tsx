...
import {
  ...
  SOFA7_ADMIN_TOP_PRODUCTS,
  SOFA7_ADMIN_ORDER_SERIES,
  SOFA7_ADMIN_CHANNEL_CHART,
  SOFA7_ADMIN_REVENUE_SERIES,
} from '../sofa7-admin-data';

// ----------------------------------------------------------------------

const PALETTE = ['#FFD600', '#00E5FF', '#FF3D3D', '#6B6B6B', '#1A1A1A'];

export function Sofa7AdminCharts() {
  ...
  const channelOptions = useChart({
    colors: PALETTE,
    labels: SOFA7_ADMIN_CHANNEL_CHART.labels,
    stroke: { width: 0 },
  ...
  const topProductOptions = useChart({
    colors: [PALETTE[1]],
    xaxis: { categories: SOFA7_ADMIN_TOP_PRODUCTS.labels },
    ...
    <Grid container spacing={3}>
      <Grid xs={12} md={8}>
        <Card>
          ...
          <Chart
            type="line"
            series={SOFA7_ADMIN_REVENUE_SERIES}
      ...
      <Grid xs={12} md={4}>
        <Card sx={{ height: 1 }}>
          ...
          <Chart
            type="donut"
            series={SOFA7_ADMIN_CHANNEL_CHART.series}
      ...
      <Grid xs={12} md={6}>
        <Card>
          ...
          <Chart
            type="bar"
            series={SOFA7_ADMIN_ORDER_SERIES}
      ...
      <Grid xs={12} md={6}>
        <Card>
          ...
          <Chart
            type="bar"
            series={[{ name: 'Đã bán', data: SOFA7_ADMIN_TOP_PRODUCTS.series }]}
