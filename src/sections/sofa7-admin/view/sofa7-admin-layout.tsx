...
import { SOFA7_ADMIN_ROOT, SOFA7_ADMIN_GROUPS } from '../sofa7-admin-data';
import { SOFA7_ADMIN_TOOLS } from '../sofa7-admin-tools';
...
export function Sofa7AdminLayout({
  children,
  activeGroup,
  activeModule,
  title,
  ...
  const [openGroups, setOpenGroups] = useState<string[]>(
    activeGroup ? [activeGroup] : [SOFA7_ADMIN_GROUPS[0].slug]
  );
...
export const SOFA7_ADMIN_THEME = { BG, SURFACE, ACCENT, TEXT };
