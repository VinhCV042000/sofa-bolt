...
import { SOFA7_ADMIN_GROUPS } from './sofa7-admin-data';

// ----------------------------------------------------------------------
// Kho dữ liệu CRUD tại chỗ (in-memory) cho khu quản trị sofa7.
// Dữ liệu khởi tạo từ SOFA7_ADMIN_GROUPS và giữ nguyên khi chuyển trang.
// ----------------------------------------------------------------------
...
SOFA7_ADMIN_GROUPS.forEach((group) => {
...
export function useSofa7AdminRows(groupSlug: string, moduleSlug: string) {
