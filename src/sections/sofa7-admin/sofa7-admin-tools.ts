// SOFA7 ADMIN — các trang tiện ích bổ sung (báo cáo, cài đặt, thông báo, hồ sơ)
// ----------------------------------------------------------------------

export type Sofa7AdminTool = {
  slug: string;
  name: string;
  icon: string;
  description: string;
...
export const SOFA7_ADMIN_TOOLS: Sofa7AdminTool[] = [
  {
    slug: 'reports',
...
export const findSofa7AdminTool = (slug?: string) =>
  SOFA7_ADMIN_TOOLS.find((tool) => tool.slug === slug);

// ----------------------------------------------------------------------

export type Sofa7FunnelStep = {
  label: string;
  value: number;
  icon: string;
  desc: string;
...
export const SOFA7_ADMIN_FUNNEL: Sofa7FunnelStep[] = [
  {
    label: 'Lượt truy cập',
    value: 128400,
...
export const SOFA7_SETTINGS_FIELDS = [
...
export const SOFA7_SETTINGS_TOGGLES = [
...
export const SOFA7_NOTIFICATIONS = [
