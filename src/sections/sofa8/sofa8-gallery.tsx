...
import { SOFA8_COLORS, SOFA8_GALLERY } from './sofa8-data';

// ----------------------------------------------------------------------

export function Sofa8Gallery({ sx, ...other }: BoxProps) {
  return (
    <Box
      component="section"
      id="gallery"
              ...
              >
                ...
                <Box
                  sx={{
                    inset: 0,
                    position: 'absolute',
                    background: `linear-gradient(to top, ${varAlpha(SOFA8_COLORS.oceanDeep, 0.88)}, transparent 60%)`,
                  }}
                />
                <Stack
                  direction="row"
                ...
                >
                  ...
                  <Stack
                    ...
                    sx={{
                      ...
                      py: 0.5,
                      borderRadius: 20,
                      bgcolor: varAlpha(SOFA8_COLORS.coral, 0.85),
                    }}
                  >
                    <Iconify icon="solar:water-bold-duotone" width={14} sx={{ color: 'common.white' }} />
