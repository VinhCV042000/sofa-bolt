// SOFA8 ADMIN — các trang tiện ích bổ sung (báo cáo, cài đặt, thông báo, hồ sơ)
// ----------------------------------------------------------------------

export type Sofa8AdminTool = {
  slug: string;
  name: string;
  icon: string;
  description: string;
...
export const SOFA8_ADMIN_TOOLS: Sofa8AdminTool[] = [
  {
    slug: 'reports',
...
export const findSofa8AdminTool = (slug?: string) =>
  SOFA8_ADMIN_TOOLS.find((tool) => tool.slug === slug);

// ----------------------------------------------------------------------

export type Sofa8FunnelStep = {
  label: string;
  value: number;
  icon: string;
  desc: string;
...
export const SOFA8_ADMIN_FUNNEL: Sofa8FunnelStep[] = [
  {
    label: 'Lượt truy cập',
    value: 128400,
...
export const SOFA8_SETTINGS_FIELDS = [
...
export const SOFA8_SETTINGS_TOGGLES = [
...
export const SOFA8_NOTIFICATIONS = [
