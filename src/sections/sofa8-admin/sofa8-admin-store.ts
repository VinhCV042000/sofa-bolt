...
import { SOFA8_ADMIN_GROUPS } from './sofa8-admin-data';

// ----------------------------------------------------------------------
// Kho dữ liệu CRUD tại chỗ (in-memory) cho khu quản trị sofa8.
// Dữ liệu khởi tạo từ SOFA8_ADMIN_GROUPS và giữ nguyên khi chuyển trang.
// ----------------------------------------------------------------------
...
SOFA8_ADMIN_GROUPS.forEach((group) => {
...
export function useSofa8AdminRows(groupSlug: string, moduleSlug: string) {
