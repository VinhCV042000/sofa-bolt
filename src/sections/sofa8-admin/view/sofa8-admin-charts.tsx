...
import {
  ...
  SOFA8_ADMIN_TOP_PRODUCTS,
  SOFA8_ADMIN_ORDER_SERIES,
  SOFA8_ADMIN_CHANNEL_CHART,
  SOFA8_ADMIN_REVENUE_SERIES,
} from '../sofa8-admin-data';

// ----------------------------------------------------------------------

const PALETTE = ['#E5B876', '#2E9CCA', '#E4784E', '#8CA9B4', '#0B2E3F'];

export function Sofa8AdminCharts() {
  ...
  const channelOptions = useChart({
    colors: PALETTE,
    labels: SOFA8_ADMIN_CHANNEL_CHART.labels,
    stroke: { width: 0 },
  ...
  const topProductOptions = useChart({
    colors: [PALETTE[1]],
    xaxis: { categories: SOFA8_ADMIN_TOP_PRODUCTS.labels },
    ...
    <Grid container spacing={3}>
      <Grid xs={12} md={8}>
        <Card>
          ...
          <Chart
            type="line"
            series={SOFA8_ADMIN_REVENUE_SERIES}
      ...
      <Grid xs={12} md={4}>
        <Card sx={{ height: 1 }}>
          ...
          <Chart
            type="donut"
            series={SOFA8_ADMIN_CHANNEL_CHART.series}
      ...
      <Grid xs={12} md={6}>
        <Card>
          ...
          <Chart
            type="bar"
            series={SOFA8_ADMIN_ORDER_SERIES}
      ...
      <Grid xs={12} md={6}>
        <Card>
          ...
          <Chart
            type="bar"
            series={[{ name: 'Đã bán', data: SOFA8_ADMIN_TOP_PRODUCTS.series }]}
