...
import { SOFA8_ADMIN_ROOT, SOFA8_ADMIN_GROUPS } from '../sofa8-admin-data';
import { SOFA8_ADMIN_TOOLS } from '../sofa8-admin-tools';
...
export function Sofa8AdminLayout({
  children,
  activeGroup,
  activeModule,
  title,
  ...
  const [openGroups, setOpenGroups] = useState<string[]>(
    activeGroup ? [activeGroup] : [SOFA8_ADMIN_GROUPS[0].slug]
  );
...
export const SOFA8_ADMIN_THEME = { BG, SURFACE, ACCENT, TEXT };
