import { SOFA5_PAGE_IMAGES, SOFA5_PAGE_PRODUCTS } from './sofa5-pages-data';

// ----------------------------------------------------------------------

export const SOFA5_AUTH_MODES: Record<string, { title: string; subtitle: string; cta: string }> = {
  login: { title: 'ĐĂNG NHẬP', subtitle: 'Truy cập tài khoản Sofa5 Riviera của bạn.', cta: 'Đăng nhập' },
...
export const SOFA5_ACCOUNT_SECTIONS = [
...
export const SOFA5_B2B_SECTIONS = [
  { slug: '', title: 'Giới thiệu hợp tác', desc: 'Chương trình hợp tác đại lý & dự án của Sofa5.', icon: 'solar:hand-shake-bold-duotone' },
...
export const SOFA5_SUPPORT_SECTIONS = [
  { slug: 'faq', title: 'FAQ', desc: 'Câu hỏi thường gặp về sản phẩm & dịch vụ.', icon: 'solar:question-circle-bold-duotone', path: '/sofa5/faq' },
  { slug: 'center', title: 'Trung tâm trợ giúp', desc: 'Tổng hợp hướng dẫn và tài liệu hỗ trợ.', icon: 'solar:book-bold-duotone', path: '/sofa5/support' },
  { slug: 'chat', title: 'Chat trực tuyến', desc: 'Trò chuyện cùng tư vấn viên Riviera.', icon: 'solar:chat-round-dots-bold-duotone', path: '/sofa5/support/chat' },
  { slug: 'ticket', title: 'Gửi ticket hỗ trợ', desc: 'Tạo yêu cầu hỗ trợ và theo dõi tiến độ.', icon: 'solar:ticket-bold-duotone', path: '/sofa5/support/ticket' },
  { slug: 'buying-guide', title: 'Hướng dẫn mua hàng', desc: 'Các bước đặt hàng trực tuyến.', icon: 'solar:cart-check-bold-duotone', path: '/sofa5/support/buying-guide' },
  { slug: 'payment-guide', title: 'Hướng dẫn thanh toán', desc: 'Các phương thức thanh toán được hỗ trợ.', icon: 'solar:card-bold-duotone', path: '/sofa5/support/payment-guide' },
];

export const SOFA5_POLICIES: Record<string, { title: string; body: string[] }> = {
  shipping: {
  ...
  privacy: {
    ...
    body: [
      ...
      'Sofa5 không chia sẻ dữ liệu khách hàng cho bên thứ ba khi chưa được đồng ý.',
    ],
  },
};

export const SOFA5_MEMBER_CUSTOMER = [
...
export const SOFA5_MEMBER_DEALER = [
...
export const SOFA5_CART_ITEMS = SOFA5_PAGE_PRODUCTS.slice(0, 3).map((p, i) => ({
  id: p.id,
  name: p.name,
  image: p.image,
  price: p.price,
...
export const SOFA5_SHOP_IMAGES = SOFA5_PAGE_IMAGES;
