...
export function Sofa4PageHero({ title, subtitle, image, overline, sx, ...other }: Sofa4PageHeroProps & Omit<BoxProps, 'title'>) {
          ...
          <Box component={m.div} variants={varFade({ distance: 24 }).inUp}>
            <Typography
              ...
              sx={{
                ...
                '& span': {
                  ...textGradient(`135deg, ${theme.vars.palette.warning.light}, ${theme.vars.palette.error.light}`),
                },
              }}
            >
              {title}
...
export function Sofa4Section({ children, bg = 'default', py = { xs: 8, md: 12 } }: { children: React.ReactNode; bg?: 'default' | 'paper' | 'grey'; py?: { xs: number; md: number } }) {
