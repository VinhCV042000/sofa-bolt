...
export function Sofa2Cta({ sx, ...other }: BoxProps) {
  return (
        ...
        >
          ...
          <Box
            sx={{
              ...
              position: 'absolute',
              background: (t) =>
                `linear-gradient(90deg, ${varAlpha(t.vars.palette.grey['900Channel'], 0.92)}, ${varAlpha(t.vars.palette.grey['900Channel'], 0.64)})`,
            }}
          />
          ...
          <Grid container>
              ...
              >
                <Stack spacing={2}>
                  ...
                  <Typography sx={{ color: varAlpha('#FFFFFF', 0.64), lineHeight: 1.8 }}>
                    Trải nghiệm độ êm, chất liệu thật và nhận tư vấn 1:1. Đặt hẹn trước để giảm 10%
                    cho đơn đầu tiên — trả góp 0% trong 6 tháng.
                  </Typography>
                </Stack>
            ...
            <Grid xs={12} md={5}>
              ...
              >
                {[
                  { icon: 'solar:phone-bold-duotone', label: 'Hotline', value: '1900 7788' },
                  { icon: 'solar:map-point-bold-duotone', label: 'Showroom', value: '12 Nguyễn Huệ, Q1, TP.HCM' },
                  { icon: 'solar:clock-circle-bold-duotone', label: 'Giờ mở cửa', value: '9:00 - 21:00 (T2 - CN)' },
                ].map((item) => (
