...
export function Sofa1AdminLayout({
  children,
  activeGroup,
  activeModule,
  title,
  ...
  const [openGroups, setOpenGroups] = useState<string[]>(
    activeGroup ? [activeGroup] : [SOFA1_ADMIN_GROUPS[0].slug]
  );
                  ...
                  {group.modules.map((module) => {
                    ...
                    return (
                      <ButtonBase
                        key={module.slug}
                        component={RouterLink}
                        href={`${SOFA1_ADMIN_ROOT}/${group.slug}/${module.slug}`}
                        sx={{
                          gap: 1.25,
                          px: 1.5,
                          py: 0.85,
...
export const SOFA1_ADMIN_THEME = { BG, SURFACE, ACCENT, TEXT };
