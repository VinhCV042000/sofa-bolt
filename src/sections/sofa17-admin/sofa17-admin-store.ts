...
import { SOFA17_ADMIN_GROUPS } from './sofa17-admin-data';

// ----------------------------------------------------------------------
// Kho dữ liệu CRUD tại chỗ (in-memory) cho khu quản trị sofa17.
// Dữ liệu khởi tạo từ SOFA17_ADMIN_GROUPS và giữ nguyên khi chuyển trang.
// ----------------------------------------------------------------------
...
SOFA17_ADMIN_GROUPS.forEach((group) => {
...
export function useSofa17AdminRows(groupSlug: string, moduleSlug: string) {
