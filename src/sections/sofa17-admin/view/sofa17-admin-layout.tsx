...
import { SOFA17_ADMIN_ROOT, SOFA17_ADMIN_GROUPS } from '../sofa17-admin-data';
import { SOFA17_ADMIN_TOOLS } from '../sofa17-admin-tools';
...
export function Sofa17AdminLayout({
  children,
  activeGroup,
  activeModule,
  title,
  ...
  const [openGroups, setOpenGroups] = useState<string[]>(
    activeGroup ? [activeGroup] : [SOFA17_ADMIN_GROUPS[0].slug]
  );
...
export const SOFA17_ADMIN_THEME = { BG, SURFACE, ACCENT, TEXT };
