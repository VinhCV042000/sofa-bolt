// SOFA17 ADMIN — các trang tiện ích bổ sung (báo cáo, cài đặt, thông báo, hồ sơ)
// ----------------------------------------------------------------------

export type Sofa17AdminTool = {
  slug: string;
  name: string;
  icon: string;
  description: string;
...
export const SOFA17_ADMIN_TOOLS: Sofa17AdminTool[] = [
  {
    slug: 'reports',
...
export const findSofa17AdminTool = (slug?: string) =>
  SOFA17_ADMIN_TOOLS.find((tool) => tool.slug === slug);

// ----------------------------------------------------------------------

export type Sofa17FunnelStep = {
  label: string;
  value: number;
  icon: string;
  desc: string;
...
export const SOFA17_ADMIN_FUNNEL: Sofa17FunnelStep[] = [
  {
    label: 'Lượt truy cập',
    value: 128400,
...
export const SOFA17_SETTINGS_FIELDS = [
...
export const SOFA17_SETTINGS_TOGGLES = [
...
export const SOFA17_NOTIFICATIONS = [
