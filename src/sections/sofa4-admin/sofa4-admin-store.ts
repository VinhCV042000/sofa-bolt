...
import { SOFA4_ADMIN_GROUPS } from './sofa4-admin-data';

// ----------------------------------------------------------------------
// Kho dữ liệu CRUD tại chỗ (in-memory) cho khu quản trị sofa4.
// Dữ liệu khởi tạo từ SOFA4_ADMIN_GROUPS và giữ nguyên khi chuyển trang.
// ----------------------------------------------------------------------
...
SOFA4_ADMIN_GROUPS.forEach((group) => {
...
export function useSofa4AdminRows(groupSlug: string, moduleSlug: string) {
