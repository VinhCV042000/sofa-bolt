...
import {
  ...
  SOFA4_ADMIN_ROOT,
  SOFA4_ADMIN_GROUPS,
  SOFA4_ADMIN_ACTIVITIES,
} from '../sofa4-admin-data';

// ----------------------------------------------------------------------

const { ACCENT, SURFACE } = SOFA4_ADMIN_THEME;

export function Sofa4AdminDashboardView() {
  return (
    <>
      <Helmet>
        ...
        <Grid container spacing={3}>
                ...
                {SOFA4_ADMIN_GROUPS.map((group) => (
                  <Grid key={group.slug} xs={12} sm={6}>
                    <ButtonBase
                      ...
                      href={`${SOFA4_ADMIN_ROOT}/${group.slug}/${group.modules[0].slug}`}
                      sx={{
                        width: 1,
                        p: 2,
                        gap: 2,
          ...
          <Grid xs={12} md={4}>
            <Card sx={{ p: 3, height: 1 }}>
              ...
              <Stack spacing={2.5}>
                {SOFA4_ADMIN_ACTIVITIES.map((item) => (
