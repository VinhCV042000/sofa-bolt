import { SOFA18_PAGE_IMAGES, SOFA18_PAGE_PRODUCTS } from './sofa18-pages-data';

// ----------------------------------------------------------------------

export const SOFA18_AUTH_MODES: Record<string, { title: string; subtitle: string; cta: string }> = {
  login: { title: 'ĐĂNG NHẬP', subtitle: 'Truy cập tài khoản Sofa18 Riviera của bạn.', cta: 'Đăng nhập' },
...
export const SOFA18_ACCOUNT_SECTIONS = [
...
export const SOFA18_B2B_SECTIONS = [
  { slug: '', title: 'Giới thiệu hợp tác', desc: 'Chương trình hợp tác đại lý & dự án của Sofa18.', icon: 'solar:hand-shake-bold-duotone' },
...
export const SOFA18_SUPPORT_SECTIONS = [
  { slug: 'faq', title: 'FAQ', desc: 'Câu hỏi thường gặp về sản phẩm & dịch vụ.', icon: 'solar:question-circle-bold-duotone', path: '/sofa18/faq' },
  { slug: 'center', title: 'Trung tâm trợ giúp', desc: 'Tổng hợp hướng dẫn và tài liệu hỗ trợ.', icon: 'solar:book-bold-duotone', path: '/sofa18/support' },
  { slug: 'chat', title: 'Chat trực tuyến', desc: 'Trò chuyện cùng tư vấn viên Riviera.', icon: 'solar:chat-round-dots-bold-duotone', path: '/sofa18/support/chat' },
  { slug: 'ticket', title: 'Gửi ticket hỗ trợ', desc: 'Tạo yêu cầu hỗ trợ và theo dõi tiến độ.', icon: 'solar:ticket-bold-duotone', path: '/sofa18/support/ticket' },
  { slug: 'buying-guide', title: 'Hướng dẫn mua hàng', desc: 'Các bước đặt hàng trực tuyến.', icon: 'solar:cart-check-bold-duotone', path: '/sofa18/support/buying-guide' },
  { slug: 'payment-guide', title: 'Hướng dẫn thanh toán', desc: 'Các phương thức thanh toán được hỗ trợ.', icon: 'solar:card-bold-duotone', path: '/sofa18/support/payment-guide' },
];

export const SOFA18_POLICIES: Record<string, { title: string; body: string[] }> = {
  shipping: {
  ...
  privacy: {
    ...
    body: [
      ...
      'Sofa18 không chia sẻ dữ liệu khách hàng cho bên thứ ba khi chưa được đồng ý.',
    ],
  },
};

export const SOFA18_MEMBER_CUSTOMER = [
...
export const SOFA18_MEMBER_DEALER = [
...
export const SOFA18_CART_ITEMS = SOFA18_PAGE_PRODUCTS.slice(0, 3).map((p, i) => ({
  id: p.id,
  name: p.name,
  image: p.image,
  price: p.price,
...
export const SOFA18_ORDER_STEPS = [
  { label: 'Đã tiếp nhận', desc: 'Đơn hàng được xác nhận bởi Sofa18.' },
...
export const SOFA18_SHOP_IMAGES = SOFA18_PAGE_IMAGES;
