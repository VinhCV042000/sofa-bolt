...
export const paths = {
  ...
  // SOFA PAGES
  sofaAbout: '/about',
  sofaServices: '/services',
  sofaServiceDetail: '/services/:id',
  sofaTraining: '/training',
  sofaBlog: '/blog',
  sofaBlogDetail: '/blog/:id',
  sofaCareers: '/careers',
  sofaBooking: '/booking',
  sofaOffers: '/offers',
  sofaFeedback: '/feedback',
  sofaPromotions: '/promotions',
  sofaBranches: '/branches',
  sofaAccount: '/account',
  sofaPartners: '/partners',
  sofaPackages: '/packages',
