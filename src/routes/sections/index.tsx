...
// SOFA1 PAGES
const Sofa1AdminPage = lazy(() => import('src/pages/sofa1-admin'));
const Sofa1AdminGroupPage = lazy(() => import('src/pages/sofa1-admin/group'));
const Sofa1AdminSectionPage = lazy(() => import('src/pages/sofa1-admin/section'));
