...
const Sofa8AdminDashboardPage = lazy(() => import('src/pages/sofa8-admin'));
const Sofa8AdminModulePage = lazy(() => import('src/pages/sofa8-admin/module'));
const Sofa8AdminToolsPage = lazy(() => import('src/pages/sofa8-admin/tools'));
const Sofa18AdminDashboardPage = lazy(() => import('src/pages/sofa18-admin'));
const Sofa18AdminModulePage = lazy(() => import('src/pages/sofa18-admin/module'));
const Sofa18AdminToolsPage = lazy(() => import('src/pages/sofa18-admin/tools'));
...
const Sofa13AdminDashboardPage = lazy(() => import('src/pages/sofa13-admin'));
const Sofa13AdminModulePage = lazy(() => import('src/pages/sofa13-admin/module'));
const Sofa13AdminToolsPage = lazy(() => import('src/pages/sofa13-admin/tools'));
...
export function Router() {
  return useRoutes([
    ...
    // SOFA19 ADMIN
    {
      ...
      element: (
        <Suspense fallback={<SplashScreen />}>
          <Sofa19AdminDashboardPage />
        </Suspense>
      ),
    },
    {
      path: '/sofa19/admin/tools/:tool',
      element: (
        <Suspense fallback={<SplashScreen />}>
          <Sofa19AdminToolsPage />
        </Suspense>
      ),
    },
    {
      path: '/sofa19/admin/:group/:module',
      element: (
        <Suspense fallback={<SplashScreen />}>
    ...
    // SOFA13 ADMIN
    {
      ...
      element: (
        <Suspense fallback={<SplashScreen />}>
          <Sofa13AdminDashboardPage />
        </Suspense>
      ),
    },
    {
      path: '/sofa13/admin/tools/:tool',
      element: (
        <Suspense fallback={<SplashScreen />}>
          <Sofa13AdminToolsPage />
        </Suspense>
      ),
    },
    {
      path: '/sofa13/admin/:group/:module',
      element: (
        <Suspense fallback={<SplashScreen />}>
    ...
    // SOFA14 ADMIN
    {
      ...
      element: (
        <Suspense fallback={<SplashScreen />}>
          <Sofa14AdminDashboardPage />
        </Suspense>
      ),
    },
    {
      path: '/sofa14/admin/tools/:tool',
      element: (
        <Suspense fallback={<SplashScreen />}>
          <Sofa14AdminToolsPage />
        </Suspense>
      ),
    },
    {
      path: '/sofa14/admin/:group/:module',
      element: (
        <Suspense fallback={<SplashScreen />}>
          <Sofa14AdminModulePage />
        </Suspense>
      ),
    },
    {
      path: '/sofa14/admin/:group',
      element: (
        <Suspense fallback={<SplashScreen />}>
          <Sofa14AdminModulePage />
        </Suspense>
